...
.vrb_map = list(
    ...
    vInp2Lo = c("comm", "region", "year", "slicep", "slice"), 
    vOut2Lo = c("comm", "region", "year", "slicep", "slice"), 
...
.vrb_mapping = list(
  ...
  vSupOut = "vSupOut( sup , comm , region , year , slice ) $ ( mSupSlice( sup , slice ) and mSupComm( sup , comm ) and mSupSpan( sup , region ) )",
  vSupReserve = "vSupReserve( sup , comm , region ) $ mSupReserveUp( sup , comm , region )",
  ...
  vInp2Lo = "vInp2Lo( comm , region , year , slicep , slice ) $ mInp2Lo( comm , region , year , slice )",
  vOut2Lo = "vOut2Lo( comm , region , year , slicep , slice ) $ mOut2Lo( comm , region , year , slice )",
  ...
  vImport = "vImport( comm , region , year , slice ) $ mImport( comm , dst , year , slice )",
  vExport = "vExport( comm , region , year , slice ) $ mExport( comm , dst , year , slice )",
  vTradeIr = "vTradeIr( trade , comm , region , region , year , slice ) $ ( mTradeIr( trade , src , dst , year , slice ) and mTradeComm( trade , comm ) )",
  ...
  vExportRow = "vExportRow( expp , comm , region , year , slice ) $ mExportRow( expp , comm , src , year , slice )",
