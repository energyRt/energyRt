...
.vrb_mapping = list(
  ...
  vStorageAInp = "vStorageAInp( stg , comm , region , year , slice ) $ ( mStorageAInp( stg , comm ) and mCommSlice( comm , slice ) and mStorageSpan( stg , region , year ) )",
  vStorageAOut = "vStorageAOut( stg , comm , region , year , slice ) $ ( mStorageAOut( stg , comm ) and mCommSlice( comm , slice ) and mStorageSpan( stg , region , year ) )",
  vTotalCost = "vTotalCost( region , year ) $ mMidMilestone( year )",
  ...
  vStorageInp = "vStorageInp( stg , comm , region , year , slice ) $ ( mStorageSpan( stg , region , year ) and mStorageComm( stg , comm ) and mCommSlice( comm , slice ) )",
  vStorageOut = "vStorageOut( stg , comm , region , year , slice ) $ ( mStorageSpan( stg , region , year ) and mStorageComm( stg , comm ) and mCommSlice( comm , slice ) )",
  vStorageStore = "vStorageStore( stg , comm , region , year , slice ) $ ( mStorageSpan( stg , region , year ) and mStorageComm( stg , comm ) and mCommSlice( comm , slice ) )",
  vStorageInv = "vStorageInv( stg , region , year ) $ mStorageNew( stg , region , year )",
  vStorageEac = "vStorageEac( stg , region , year ) $ mStorageSpan( stg , region , year )",
  ...
  *vStorageSalv = "*vStorageSalv( stg , region ) $ ( sum( year $ mStorageSpan( stg , region , year_cns ) , 1 ) <> 0 )",
  ...
  vTradeCap = "vTradeCap( trade , year ) $ ( mTradeCapacityVariable( trade ) and mMidMilestone( year ) and mTradeSpan( trade , year ) )",
  ...
  vTradeEac = "vTradeEac( trade , region , year ) $ ( mTradeCapacityVariable( trade ) and mTradeSpan( trade , region ) and mMilestoneLast( yeare ) )",
