...
.vrb_mapping = list(
  ...
  vTechRetiredCap = "vTechRetiredCap( tech , region , year , year ) $ mvTechRetiredCap( tech , region , year , year )",
  ...
  vOutTot = "vOutTot( comm , region , year , slice ) $ mvBalance( comm , region , year , slice )",
  vInpTot = "vInpTot( comm , region , year , slice ) $ mvBalance( comm , region , year , slice )",
