.write_mapping <- function(prec, interpolation_time_begin, interpolation_count) {
  ...
  .interpolation_message('region', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  region <- getParameterData(prec@parameters$region)
  .interpolation_message('mMidMilestone', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  year <- getParameterData(prec@parameters$mMidMilestone)
  .interpolation_message('mSliceParentChildE', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  # Total parameter ruductions
  mSliceParentChildE <- getParameterData(prec@parameters$mSliceParentChildE)
  .interpolation_message('mCommSlice', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mCommSliceOrParent', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  # mCommSliceOrParent
  ...
  .interpolation_message('mTechInpTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mTechOutTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mSupOutTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  prec@parameters[['mSupOutTot']] <- addData(prec@parameters[['mSupOutTot']], reduce.sect(
    getParameterData(prec@parameters$mSupAva)[, -1]))
  .interpolation_message('mDemInp', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('pEmissionFactor', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mvTechAct', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mTechEmsFuel', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  colnames(tmp)[3] <- 'comm.1'
  prec@parameters[['mTechEmsFuel']] <- addData(prec@parameters[['mTechEmsFuel']], tmp)
  .interpolation_message('mEmsFuelTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mDummyImport', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  no_inf <- function(x) {
  ...
  .interpolation_message('mDummyExport', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  prec@parameters[['mDummyExport']] <- addData(prec@parameters[['mDummyExport']], no_inf('pDummyExportCost'))
  .interpolation_message('mDummyCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mvTradeIrAInpTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mvTradeIrAOutTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
  ...
  .interpolation_message('mTradeComm', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mStorageOutTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    prec@parameters[['mStorageOutTot']] <- addData(prec@parameters[['mStorageOutTot']], 
      reduce.sect(rbind(getParameterData(prec@parameters$mvStorageAInp)[, -1], getParameterData(prec@parameters$mvStorageStore)[, -1])))
    .interpolation_message('mTaxCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mSubsCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mAggOut', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mOut2Lo', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mInp2Lo', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mvTradeCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    
    ##
    dregionyear <- merge(region, year)
    .interpolation_message('mvTradeCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    prec@parameters[['mvTradeCost']] <- addData(prec@parameters[['mvTradeCost']], dregionyear)
    .interpolation_message('mvTradeRowCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    prec@parameters[['mvTradeRowCost']] <- addData(prec@parameters[['mvTradeRowCost']], dregionyear)
    .interpolation_message('mvTradeIrCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    prec@parameters[['mvTradeIrCost']] <- addData(prec@parameters[['mvTradeIrCost']], dregionyear)
    .interpolation_message('mvDemInp', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mvTotalCost', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    
    prec@parameters[['mvTotalCost']] <- addData(prec@parameters[['mvTotalCost']], dregionyear)
    .interpolation_message('mvInp2Lo', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('meqLECActivity', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('pWeather', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    if (nrow(pWeather) > 0) {
      ...
      .interpolation_message('pWeatherUp', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
      ...
      .interpolation_message('pWeatherLo', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    for (i in seq_len(nrow(towth))) {
      .interpolation_message(towth[i, 3], rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mvInpTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    mvInpTot <- rbind(
    ...
    .interpolation_message('mvOutTot', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    mvOutTot <- rbind(
    ...
    .interpolation_message('mvBalance', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('meqBalUp', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('meqBalFx', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    .interpolation_message('mAggregateFactor', rest, interpolation_count, interpolation_time_begin); rest = rest + 1
    ...
    cat(bacs, paste0(rep(' ', 100), collapse = ''), bacs)
    prec
}
