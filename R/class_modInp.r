...
setMethod("initialize", "modInp",
  ...
  # Create parameters
    ...
    # me*
    .Object@parameters[['meqTechSng2Sng']] <- createParameter('meqTechSng2Sng', c('tech', 'region', 'comm', 'commp', 'year', 'slice'), 'map')
    .Object@parameters[['meqTechGrp2Sng']] <- createParameter('meqTechGrp2Sng', c('tech', 'region', 'group', 'commp', 'year', 'slice'), 'map')
    .Object@parameters[['meqTechSng2Grp']] <- createParameter('meqTechSng2Grp', c('tech', 'region', 'comm', 'groupp', 'year', 'slice'), 'map')
    .Object@parameters[['meqTechGrp2Grp']] <- createParameter('meqTechGrp2Grp', c('tech', 'region', 'group', 'groupp', 'year', 'slice'), 'map')
    ...
    .Object@parameters[['meqTechCap']] <- createParameter('meqTechCap', c('tech', 'region', 'year'), 'map')
    ...
    .Object@parameters[['meqStorageStore']] <- createParameter('meqStorageStore', c('stg', 'comm', 'region', 'year', 'slice'), 'map')
    ...
    .Object@parameters[['meqStorageClean']] <- createParameter('meqStorageClean', c('stg', 'comm', 'region', 'year', 'slice'), 'map')
    ...
    .Object@parameters[['meqStorageCost']] <- createParameter('meqStorageCost', c('stg', 'region', 'year'), 'map')
    ...
    .Object@parameters[['meqExportRowResUp']] <- createParameter('meqExportRowResUp', c('expp', 'comm'), 'map')
    ...
    .Object@parameters[['meqSupOutTot']] <- createParameter('meqSupOutTot', c('comm', 'region', 'year', 'slice'), 'map')
