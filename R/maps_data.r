...
..getVariables <- function() {
   ...
   eqLECActivity  = logical(),
    ...
    rs["vTechNewCap", c("tech", "region", "year", "eqTechAInp", "eqTechAOut", "eqTechCap", "eqTechNewCap", "eqTechEac", "eqTechInv")] <- TRUE;
    rs["vTechRetiredCap", c("name", "description")] <- c("vTechRetiredCap", "Early retired capacity");
    rs["vTechRetiredCap", c("tech", "region", "year", "eqTechCap", "eqTechNewCap", "eqTechEac")] <- TRUE;
...
..getParameters <- function() {
   ...
   eqLECActivity  = logical(),
      stringsAsFactors = FALSE);
    rs[1:306,] <- NA;
    rownames(rs) <- c("tech", "sup", "dem", "stg", "expp", "imp", "trade", "group", "comm", "region", "year", "slice", "weather", "mSameRegion", "mSameSlice", "mMilestoneFirst", "mMilestoneLast", "mMilestoneNext", "mMilestoneHasNext", "mStartMilestone", "mEndMilestone", "mMidMilestone", "mCommSlice", "mCommSliceOrParent", "mTechRetirement", "mTechUpgrade", "mTechInpComm", "mTechOutComm", "mTechInpGroup", "mTechOutGroup", "mTechOneComm", "mTechGroupComm", "mTechAInp", "mTechAOut", "mTechNew", "mTechSpan", "mTechSlice", "mSupSlice", "mSupComm", "mSupSpan", "mSupWeatherLo", "mSupWeatherUp", "mWeatherSlice", "mWeatherRegion", "mDemComm", "mUpComm", "mLoComm", "mFxComm", "mStorageFullYear", "mStorageComm", "mStorageAInp", "mStorageAOut", "mStorageNew", "mStorageSpan", "mStorageOMCost", "mStorageEac", "mSliceNext", "mSliceFYearNext", "mTradeSlice", "mTradeComm", "mTradeRoutes", "mTradeIrAInp", "mTradeIrAOut", "mExpComm", "mImpComm", "mExpSlice", "mImpSlice", "mDiscountZero", "mSliceParentChildE", "mSliceParentChild", "mTechWeatherAf", "mTechWeatherAfs", "mTechWeatherAfc", "mStorageWeatherAf", "mStorageWeatherCinp", "mStorageWeatherCout", "mTradeSpan", "mTradeNew", "mTradeOlifeInf", "mTradeEac", "mTradeCapacityVariable", "mTradeInv", "mvSupCost", "mvTechInp", "mvSupReserve", "mvTechRetiredCap", "mvTechAct", "mvTechOut", "mvTechAInp", "mvTechAOut", "mvDemInp", "mvBalance", "mvInp2Lo", "mvOut2Lo", "mvStorageAInp", "mvStorageAOut", "mvStorageStore", "mvTradeIr", "mvTradeCost", "mvTradeRowCost", "mvTradeIrCost", "mvTradeCap", "mvTradeNewCap", "mvTotalCost", "mTechInpTot", "mTechOutTot", "mTechEac", "mTechOMCost", "mSupOutTot", "mDemInp", "mEmsFuelTot", "mTechEmsFuel", "mDummyImport", "mDummyExport", "mDummyCost", "mTradeIr", "mTradeIrUp", "mvTradeIrAInp", "mvTradeIrAInpTot", "mvTradeIrAOut", "mvTradeIrAOutTot", "mImportRow", "mImportRowUp", "mImportRowAccumulatedUp", "mExportRow", "mExportRowUp", "mExportRowAccumulatedUp", "mExport", "mImport", "mStorageInpTot", "mStorageOutTot", "mTaxCost", "mSubsCost", "mAggOut", "mTechAfUp", "mTechOlifeInf", "mStorageOlifeInf", "mTechAfcUp", "mSupAvaUp", "mSupAva", "mSupReserveUp", "mOut2Lo", "mInp2Lo", "meqTechSng2Sng", "meqTechGrp2Sng", "meqTechSng2Grp", "meqTechGrp2Grp", "meqTechShareInpLo", "meqTechShareInpUp", "meqTechShareOutLo", "meqTechShareOutUp", "meqTechAfLo", "meqTechAfUp", "meqTechAfsLo", "meqTechAfsUp", "meqTechActSng", "meqTechActGrp", "meqTechAfcOutLo", "meqTechAfcOutUp", "meqTechAfcInpLo", "meqTechAfcInpUp", "meqTechCap", "meqTechNewCap", "meqSupAvaLo", "meqSupReserveLo", "meqStorageStore", "meqStorageAfLo", "meqStorageAfUp", "meqStorageClean", "meqStorageInpUp", "meqStorageInpLo", "meqStorageOutUp", "meqStorageOutLo", "meqStorageCost", "meqTradeFlowUp", "meqTradeFlowLo", "meqExportRowLo", "meqExportRowResUp", "meqImportRowUp", "meqImportRowLo", "meqTradeCapFlow", "meqBalLo", "meqBalUp", "meqBalFx", "meqSupOutTot", "meqLECActivity", "mLECRegion", "ordYear", "cardYear", "pPeriodLen", "pSliceShare", "pAggregateFactor", "pTechOlife", "pTechCinp2ginp", "pTechGinp2use", "pTechCinp2use", "pTechUse2cact", "pTechCact2cout", "pTechEmisComm", "pTechAct2AInp", "pTechCap2AInp", "pTechNCap2AInp", "pTechCinp2AInp", "pTechCout2AInp", "pTechAct2AOut", "pTechCap2AOut", "pTechNCap2AOut", "pTechCinp2AOut", "pTechCout2AOut", "pTechFixom", "pTechVarom", "pTechInvcost", "pTechEac", "pTechShareLo", "pTechShareUp", "pTechAfLo", "pTechAfUp", "pTechAfsLo", "pTechAfsUp", "pTechAfcLo", "pTechAfcUp", "pTechStock", "pTechCap2act", "pTechCvarom", "pTechAvarom", "pDiscount", "pDiscountFactor", "pSupCost", "pSupAvaUp", "pSupAvaLo", "pSupReserveUp", "pSupReserveLo", "pDemand", "pEmissionFactor", "pDummyImportCost", "pDummyExportCost", "pTaxCost", "pSubsCost", "pWeather", "pSupWeatherLo", "pSupWeatherUp", "pTechWeatherAfLo", "pTechWeatherAfUp", "pTechWeatherAfsLo", "pTechWeatherAfsUp", "pTechWeatherAfcLo", "pTechWeatherAfcUp", "pStorageWeatherAfUp", "pStorageWeatherAfLo", "pStorageWeatherCinpUp", "pStorageWeatherCinpLo", "pStorageWeatherCoutUp", "pStorageWeatherCoutLo", "pStorageInpEff", "pStorageOutEff", "pStorageStgEff", "pStorageStock", "pStorageOlife", "pStorageCostStore", "pStorageCostInp", "pStorageCostOut", "pStorageFixom", "pStorageInvcost", "pStorageEac", "pStorageCap2stg", "pStorageAfLo", "pStorageAfUp", "pStorageCinpUp", "pStorageCinpLo", "pStorageCoutUp", "pStorageCoutLo", "pStorageNCap2Stg", "pStorageCharge", "pStorageStg2AInp", "pStorageStg2AOut", "pStorageInp2AInp", "pStorageInp2AOut", "pStorageOut2AInp", "pStorageOut2AOut", "pStorageCap2AInp", "pStorageCap2AOut", "pStorageNCap2AInp", "pStorageNCap2AOut", "pTradeIrEff", "pTradeIrUp", "pTradeIrLo", "pTradeIrCost", "pTradeIrMarkup", "pTradeIrCsrc2Ainp", "pTradeIrCsrc2Aout", "pTradeIrCdst2Ainp", "pTradeIrCdst2Aout", "pExportRowRes", "pExportRowUp", "pExportRowLo", "pExportRowPrice", "pImportRowRes", "pImportRowUp", "pImportRowLo", "pImportRowPrice", "pTradeStock", "pTradeOlife", "pTradeInvcost", "pTradeEac", "pTradeCap2Act", "pLECLoACT");
    rs["tech", c("name", "description", "type")] <- c("tech", "technology", "set");
    rs["tech", c("eqTechSng2Sng", "eqTechGrp2Sng", "eqTechSng2Grp", "eqTechGrp2Grp", "eqTechShareInpLo", "eqTechShareInpUp", "eqTechShareOutLo", "eqTechShareOutUp", "eqTechAInp", "eqTechAOut", "eqTechAfLo", "eqTechAfUp", "eqTechAfsLo", "eqTechAfsUp", "eqTechActSng", "eqTechActGrp", "eqTechAfcOutLo", "eqTechAfcOutUp", "eqTechAfcInpLo", "eqTechAfcInpUp", "eqTechCap", "eqTechNewCap", "eqTechEac", "eqTechInv", "eqTechOMCost", "eqEmsFuelTot", "eqTechInpTot", "eqTechOutTot", "eqCost", "eqLECActivity")] <- TRUE;
    ...
    rs["mMidMilestone", c("year", "eqTechCap", "eqStorageCost", "eqExportRowCumulative", "eqSupOutTot")] <- TRUE;
    ...
    rs["mCommSliceOrParent", c("comm", "slice", "eqImport", "eqExport", "eqTradeIrAInpTot", "eqTradeIrAOutTot", "eqSupOutTot", "eqTechInpTot", "eqTechOutTot")] <- TRUE;
    ...
    rs["mTechInpComm", c("tech", "comm", "eqTechOMCost")] <- TRUE;
    rs["mTechOutComm", c("name", "description", "type")] <- c("mTechOutComm", "Output commodity", "map");
    rs["mTechOutComm", c("tech", "comm", "eqTechOMCost")] <- TRUE;
    ...
    rs["mTechGroupComm", c("tech", "group", "comm")] <- TRUE;
    rs["mTechAInp", c("name", "description", "type")] <- c("mTechAInp", "Auxiliary input", "map");
    rs["mTechAInp", c("tech", "comm")] <- TRUE;
    ...
    rs["mTechNew", c("tech", "region", "year", "eqTechCap", "eqTechNewCap", "eqTechEac", "eqTechInv")] <- TRUE;
    rs["mTechSpan", c("name", "description", "type")] <- c("mTechSpan", "Availability of each technology by regions and milestone years", "map");
    rs["mTechSpan", c("tech", "region", "year", "eqTechAfsLo", "eqTechAfsUp")] <- TRUE;
    rs["mTechSlice", c("name", "description", "type")] <- c("mTechSlice", "Technology to slice-level", "map");
    rs["mTechSlice", c("tech", "slice", "eqTechAfcOutLo", "eqTechAfcOutUp", "eqTechOMCost", "eqLECActivity")] <- TRUE;
    ...
    rs["mTradeSlice", c("trade", "slice")] <- TRUE;
    ...
    rs["mTradeRoutes", c("trade", "region")] <- TRUE;
    ...
    rs["mSliceParentChildE", c("slice")] <- TRUE;
    ...
    rs["mTradeSpan", c("trade", "year")] <- TRUE;
    rs["mTradeNew", c("name", "description", "type")] <- c("mTradeNew", "", "map");
    rs["mTradeNew", c("trade", "year")] <- TRUE;
    ...
    rs["mvTechInp", c("tech", "comm", "region", "year", "slice", "eqTechSng2Sng", "eqTechGrp2Sng", "eqTechSng2Grp", "eqTechGrp2Grp", "eqTechShareInpLo", "eqTechShareInpUp", "eqTechAfcInpLo", "eqTechAfcInpUp")] <- TRUE;
    rs["mvSupReserve", c("name", "description", "type")] <- c("mvSupReserve", "", "map");
    rs["mvSupReserve", c("sup", "comm", "region", "eqSupTotal", "eqSupReserveLo")] <- TRUE;
    rs["mvTechRetiredCap", c("name", "description", "type")] <- c("mvTechRetiredCap", "", "map");
    rs["mvTechRetiredCap", c("tech", "region", "year", "eqTechCap", "eqTechNewCap", "eqTechEac")] <- TRUE;
    rs["mvTechAct", c("name", "description", "type")] <- c("mvTechAct", "", "map");
    rs["mvTechAct", c("tech", "region", "year", "slice", "eqTechGrp2Grp", "eqTechAfLo", "eqTechAfUp", "eqTechAfsLo", "eqTechAfsUp", "eqTechActGrp")] <- TRUE;
    ...
    rs["mvBalance", c("comm", "region", "year", "slice", "eqBalUp", "eqBalLo", "eqBalFx", "eqBal", "eqOutTot", "eqInpTot")] <- TRUE;
    ...
    rs["mvStorageStore", c("stg", "comm", "region", "year", "slice", "eqStorageInpUp", "eqStorageInpLo", "eqStorageInpTot", "eqStorageOutTot")] <- TRUE;
    rs["mvTradeIr", c("name", "description", "type")] <- c("mvTradeIr", "", "map");
    rs["mvTradeIr", c("trade", "comm", "region", "year", "slice", "eqImport", "eqExport", "eqTradeFlowLo", "eqCostIrTrade", "eqTradeCapFlow")] <- TRUE;
    ...
    rs["mvTradeCap", c("name", "description", "type")] <- c("mvTradeCap", "", "map");
    rs["mvTradeCap", c("trade", "year", "eqTradeCap", "eqTradeCapFlow")] <- TRUE;
    rs["mvTradeNewCap", c("name", "description", "type")] <- c("mvTradeNewCap", "", "map");
    rs["mvTradeNewCap", c("trade", "year", "eqTradeCap", "eqTradeEac")] <- TRUE;
    ...
    rs["mSupOutTot", c("comm", "region", "year", "slice", "eqOutTot", "eqOut2Lo")] <- TRUE;
    ...
    rs["meqTechSng2Sng", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechGrp2Sng", c("name", "description", "type")] <- c("meqTechGrp2Sng", "", "map");
    rs["meqTechGrp2Sng", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechSng2Grp", c("name", "description", "type")] <- c("meqTechSng2Grp", "", "map");
    rs["meqTechSng2Grp", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechGrp2Grp", c("name", "description", "type")] <- c("meqTechGrp2Grp", "", "map");
    rs["meqTechGrp2Grp", c("tech", "group", "region", "year", "slice")] <- TRUE;
    rs["meqTechShareInpLo", c("name", "description", "type")] <- c("meqTechShareInpLo", "", "map");
    rs["meqTechShareInpLo", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechShareInpUp", c("name", "description", "type")] <- c("meqTechShareInpUp", "", "map");
    rs["meqTechShareInpUp", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechShareOutLo", c("name", "description", "type")] <- c("meqTechShareOutLo", "", "map");
    rs["meqTechShareOutLo", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechShareOutUp", c("name", "description", "type")] <- c("meqTechShareOutUp", "", "map");
    rs["meqTechShareOutUp", c("tech", "group", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfLo", c("name", "description", "type")] <- c("meqTechAfLo", "", "map");
    rs["meqTechAfLo", c("tech", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfUp", c("name", "description", "type")] <- c("meqTechAfUp", "", "map");
    rs["meqTechAfUp", c("tech", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfsLo", c("name", "description", "type")] <- c("meqTechAfsLo", "", "map");
    rs["meqTechAfsLo", c("tech", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfsUp", c("name", "description", "type")] <- c("meqTechAfsUp", "", "map");
    rs["meqTechAfsUp", c("tech", "region", "year", "slice")] <- TRUE;
    rs["meqTechActSng", c("name", "description", "type")] <- c("meqTechActSng", "", "map");
    rs["meqTechActSng", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechActGrp", c("name", "description", "type")] <- c("meqTechActGrp", "", "map");
    rs["meqTechActGrp", c("tech", "group", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfcOutLo", c("name", "description", "type")] <- c("meqTechAfcOutLo", "", "map");
    rs["meqTechAfcOutLo", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfcOutUp", c("name", "description", "type")] <- c("meqTechAfcOutUp", "", "map");
    rs["meqTechAfcOutUp", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfcInpLo", c("name", "description", "type")] <- c("meqTechAfcInpLo", "", "map");
    rs["meqTechAfcInpLo", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechAfcInpUp", c("name", "description", "type")] <- c("meqTechAfcInpUp", "", "map");
    rs["meqTechAfcInpUp", c("tech", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTechCap", c("name", "description", "type")] <- c("meqTechCap", "", "map");
    rs["meqTechCap", c("tech", "region", "year")] <- TRUE;
    rs["meqTechNewCap", c("name", "description", "type")] <- c("meqTechNewCap", "", "map");
    rs["meqTechNewCap", c("tech", "region", "year")] <- TRUE;
    rs["meqSupAvaLo", c("name", "description", "type")] <- c("meqSupAvaLo", "", "map");
    rs["meqSupAvaLo", c("sup", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqSupReserveLo", c("name", "description", "type")] <- c("meqSupReserveLo", "", "map");
    rs["meqSupReserveLo", c("sup", "comm", "region")] <- TRUE;
    rs["meqStorageStore", c("name", "description", "type")] <- c("meqStorageStore", "", "map");
    rs["meqStorageStore", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageAfLo", c("name", "description", "type")] <- c("meqStorageAfLo", "", "map");
    rs["meqStorageAfLo", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageAfUp", c("name", "description", "type")] <- c("meqStorageAfUp", "", "map");
    rs["meqStorageAfUp", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageClean", c("name", "description", "type")] <- c("meqStorageClean", "", "map");
    rs["meqStorageClean", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageInpUp", c("name", "description", "type")] <- c("meqStorageInpUp", "", "map");
    rs["meqStorageInpUp", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageInpLo", c("name", "description", "type")] <- c("meqStorageInpLo", "", "map");
    rs["meqStorageInpLo", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageOutUp", c("name", "description", "type")] <- c("meqStorageOutUp", "", "map");
    rs["meqStorageOutUp", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageOutLo", c("name", "description", "type")] <- c("meqStorageOutLo", "", "map");
    rs["meqStorageOutLo", c("stg", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqStorageCost", c("name", "description", "type")] <- c("meqStorageCost", "", "map");
    rs["meqStorageCost", c("stg", "region", "year")] <- TRUE;
    rs["meqTradeFlowUp", c("name", "description", "type")] <- c("meqTradeFlowUp", "", "map");
    rs["meqTradeFlowUp", c("trade", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTradeFlowLo", c("name", "description", "type")] <- c("meqTradeFlowLo", "", "map");
    rs["meqTradeFlowLo", c("trade", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqExportRowLo", c("name", "description", "type")] <- c("meqExportRowLo", "", "map");
    rs["meqExportRowLo", c("expp", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqExportRowResUp", c("name", "description", "type")] <- c("meqExportRowResUp", "", "map");
    rs["meqExportRowResUp", c("expp", "comm")] <- TRUE;
    ...
    rs["meqImportRowLo", c("imp", "comm", "region", "year", "slice")] <- TRUE;
    rs["meqTradeCapFlow", c("name", "description", "type")] <- c("meqTradeCapFlow", "", "map");
    rs["meqTradeCapFlow", c("trade", "comm", "year", "slice")] <- TRUE;
    rs["meqBalLo", c("name", "description", "type")] <- c("meqBalLo", "", "map");
    rs["meqBalLo", c("comm", "region", "year", "slice")] <- TRUE;
    rs["meqBalUp", c("name", "description", "type")] <- c("meqBalUp", "", "map");
    rs["meqBalUp", c("comm", "region", "year", "slice")] <- TRUE;
    rs["meqBalFx", c("name", "description", "type")] <- c("meqBalFx", "", "map");
    rs["meqBalFx", c("comm", "region", "year", "slice")] <- TRUE;
    rs["meqSupOutTot", c("name", "description", "type")] <- c("meqSupOutTot", "", "map");
    rs["meqSupOutTot", c("comm", "region", "year", "slice")] <- TRUE;
    rs["meqLECActivity", c("name", "description", "type")] <- c("meqLECActivity", "", "map");
    rs["meqLECActivity", c("tech", "region", "year")] <- TRUE;
