...
..getParameters <- function() {
   ...
   eqLECActivity  = logical(),
    ...
    rs["mTechSlice", c("tech", "slice", "eqTechOMCost", "eqLECActivity")] <- TRUE;
    ...
    rs["mvTechInp", c("tech", "comm", "region", "year", "slice", "eqTechGrp2Sng", "eqTechGrp2Grp", "eqTechShareInpLo", "eqTechShareInpUp")] <- TRUE;
    ...
    rs["mvTechOut", c("tech", "comm", "region", "year", "slice", "eqTechSng2Grp", "eqTechGrp2Grp", "eqTechShareOutLo", "eqTechShareOutUp", "eqTechActGrp")] <- TRUE;
    ...
    rs["mvTradeCap", c("trade", "year", "eqTradeCap")] <- TRUE;
