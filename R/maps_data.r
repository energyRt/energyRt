...
..getParameters <- function() {
   ...
   eqLECActivity  = logical(),
    ...
    rs["mTradeBiderect", c("name", "description", "type")] <- c("mTradeBiderect", "", "map");
    rs["mTradeBiderect", c("trade", "eqTradeCap", "eqTradeBiderect")] <- TRUE;
