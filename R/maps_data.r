...
..getEquations <- function() {
   ...
   vImportRow  = logical(),
    ...
    rs["eqStorageCost", c("stg", "comm", "region", "year", "slice", "vStorageCost", "vStorageInp", "vStorageOut", "vStorageStore", "vStorageInv", "vStorageCap")] <- TRUE;
    ...
    rs["eqCost", c("tech", "sup", "stg", "comm", "region", "year", "vTechOMCost", "vSupCost", "vCost", "vTaxCost", "vSubsCost", "vStorageCost", "vTradeCost", "vDummyCost")] <- TRUE;
    ...
    rs["eqObjective", c("tech", "stg", "region", "year", "vTechInv", "vTechSalv", "vCost", "vObjective", "vStorageSalv")] <- TRUE;
...
..getVariables <- function() {
   ...
   eqLECActivity  = logical(),
    ...
    rs["vStorageCost", c("name", "description")] <- c("vStorageCost", "Storage O&M costs");
    rs["vStorageCost", c("stg", "region", "year", "eqStorageCost", "eqCost")] <- TRUE;
    ...
    rs["vStorageInv", c("stg", "region", "year", "eqStorageInv", "eqStorageCost")] <- TRUE;
...
..getParameters <- function() {
   ...
   eqLECActivity  = logical(),
    ...
    rs["mStorageNew", c("stg", "region", "year", "eqStorageCost", "eqStorageSalv0", "eqStorageSalv", "eqObjective")] <- TRUE;
