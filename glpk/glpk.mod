...
s.t.  eqTechSng2Sng{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in (mTechInpComm inter mTechOneComm), (t, cp) in (mTechOutComm inter mTechOneComm) : pTechCinp2use[t,c,r,y,s] <> 0}: vTechInp[t,c,r,y,s]*pTechCinp2use[t,c,r,y,s]  =  (vTechOut[t,cp,r,y,s]) / (pTechUse2cact[t,cp,r,y,s]*pTechCact2cout[t,cp,r,y,s]);

s.t.  eqTechGrp2Sng{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechInpGroup, (t, cp) in (mTechOutComm inter mTechOneComm) : }: pTechGinp2use[t,g,r,y,s]*sum{c in comm:(((t,c) in mTechInpComm and (t,g,c) in mTechGroupComm))}(vTechInp[t,c,r,y,s]*pTechCinp2ginp[t,c,r,y,s])  =  (vTechOut[t,cp,r,y,s]) / (pTechUse2cact[t,cp,r,y,s]*pTechCact2cout[t,cp,r,y,s]);

s.t.  eqTechSng2Grp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in (mTechInpComm inter mTechOneComm), (t, gp) in mTechOutGroup : pTechCinp2use[t,c,r,y,s] <> 0}: vTechInp[t,c,r,y,s]*pTechCinp2use[t,c,r,y,s]  =  sum{cp in comm:(((t,cp) in mTechOutComm and (t,gp,cp) in mTechGroupComm))}((vTechOut[t,cp,r,y,s]) / (pTechUse2cact[t,cp,r,y,s]*pTechCact2cout[t,cp,r,y,s]));

s.t.  eqTechGrp2Grp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechInpGroup, (t, gp) in mTechOutGroup : }: pTechGinp2use[t,g,r,y,s]*sum{c in comm:(((t,c) in mTechInpComm and (t,g,c) in mTechGroupComm))}(vTechInp[t,c,r,y,s]*pTechCinp2ginp[t,c,r,y,s])  =  sum{cp in comm:(((t,cp) in mTechOutComm and (t,gp,cp) in mTechGroupComm))}((vTechOut[t,cp,r,y,s]) / (pTechUse2cact[t,cp,r,y,s]*pTechCact2cout[t,cp,r,y,s]));

s.t.  eqTechUse2Sng{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, cp) in (mTechOutComm inter mTechOneComm) : }: vTechUse[t,r,y,s]  =  (vTechOut[t,cp,r,y,s]) / (pTechCact2cout[t,cp,r,y,s]);

s.t.  eqTechUse2Grp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, gp) in mTechOutGroup : }: vTechUse[t,r,y,s]  =  sum{cp in comm:(((t,cp) in mTechOutComm and (t,gp,cp) in mTechGroupComm))}((vTechOut[t,cp,r,y,s]) / (pTechCact2cout[t,cp,r,y,s]));

s.t.  eqTechShareInpLo{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechInpGroup, (t, c) in mTechInpComm, (t, g, c) in mTechGroupComm : pTechShareLo[t,c,r,y,s] <> 0}: vTechInp[t,c,r,y,s]  >=  pTechShareLo[t,c,r,y,s]*sum{cp in comm:(((t,cp) in mTechInpComm and (t,g,cp) in mTechGroupComm))}(vTechInp[t,cp,r,y,s]);

s.t.  eqTechShareInpUp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechInpGroup, (t, c) in mTechInpComm, (t, g, c) in mTechGroupComm : pTechShareUp[t,c,r,y,s] <> 1}: vTechInp[t,c,r,y,s] <=  pTechShareUp[t,c,r,y,s]*sum{cp in comm:(((t,cp) in mTechInpComm and (t,g,cp) in mTechGroupComm))}(vTechInp[t,cp,r,y,s]);

s.t.  eqTechShareOutLo{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechOutGroup, (t, c) in mTechOutComm, (t, g, c) in mTechGroupComm : pTechShareLo[t,c,r,y,s] <> 0}: vTechOut[t,c,r,y,s]  >=  pTechShareLo[t,c,r,y,s]*sum{cp in comm:(((t,cp) in mTechOutComm and (t,g,cp) in mTechGroupComm))}(vTechOut[t,cp,r,y,s]);

s.t.  eqTechShareOutUp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, g) in mTechOutGroup, (t, c) in mTechOutComm, (t, g, c) in mTechGroupComm : pTechShareUp[t,c,r,y,s] <> 1}: vTechOut[t,c,r,y,s] <=  pTechShareUp[t,c,r,y,s]*sum{cp in comm:(((t,cp) in mTechOutComm and (t,g,cp) in mTechGroupComm))}(vTechOut[t,cp,r,y,s]);

s.t.  eqTechAInp{(t, s) in mTechSlice, y in mMidMilestone, (t, c) in mTechAInp, (t, r, y) in mTechSpan : }: vTechAInp[t,c,r,y,s]  =  (vTechUse[t,r,y,s]*pTechUse2AInp[t,c,r,y,s])+(vTechAct[t,r,y,s]*pTechAct2AInp[t,c,r,y,s])+(vTechCap[t,r,y]*pTechCap2AInp[t,c,r,y,s])+(vTechNewCap[t,r,y]*pTechNCap2AInp[t,c,r,y,s])+sum{cp in comm:(pTechCinp2AInp[t,c,cp,r,y,s])}(pTechCinp2AInp[t,c,cp,r,y,s]*vTechInp[t,cp,r,y,s])+sum{cp in comm:(pTechCout2AInp[t,c,cp,r,y,s])}(pTechCout2AInp[t,c,cp,r,y,s]*vTechOut[t,cp,r,y,s]);

s.t.  eqTechAOut{(t, s) in mTechSlice, y in mMidMilestone, (t, c) in mTechAOut, (t, r, y) in mTechSpan : }: vTechAOut[t,c,r,y,s]  =  (vTechUse[t,r,y,s]*pTechUse2AOut[t,c,r,y,s])+(vTechAct[t,r,y,s]*pTechAct2AOut[t,c,r,y,s])+(vTechCap[t,r,y]*pTechCap2AOut[t,c,r,y,s])+(vTechNewCap[t,r,y]*pTechNCap2AOut[t,c,r,y,s])+sum{cp in comm:(pTechCinp2AOut[t,c,cp,r,y,s])}(pTechCinp2AOut[t,c,cp,r,y,s]*vTechInp[t,cp,r,y,s])+sum{cp in comm:(pTechCout2AOut[t,c,cp,r,y,s])}(pTechCout2AOut[t,c,cp,r,y,s]*vTechOut[t,cp,r,y,s]);

s.t.  eqTechAfLo{(t, s) in mTechSlice, y in mMidMilestone, r in region : pTechAfLo[t,r,y,s] <> 0 and (t,r,y) in mTechSpan}: pTechAfLo[t,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (t,wth1) in mTechWeatherAf and pTechWeatherAfLo[t,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfLo[t,wth1]) <=  vTechAct[t,r,y,s];

s.t.  eqTechAfUp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, r, y, s) in mTechAfUp : }: vTechAct[t,r,y,s] <=  pTechAfUp[t,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (t,wth1) in mTechWeatherAf and pTechWeatherAfUp[t,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfUp[t,wth1]);

s.t.  eqTechAfsLo{y in mMidMilestone, t in tech, r in region, s in slice : pTechAfsLo[t,r,y,s]>0 and (t,r,y) in mTechSpan}: pTechAfsLo[t,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (t,wth1) in mTechWeatherAfs and pTechWeatherAfsLo[t,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfsLo[t,wth1]) <=  sum{sp in slice:(((t,sp) in mTechSlice and ((s,sp) in mSameSlice or (s,sp) in mAllSliceParentChild)))}(vTechAct[t,r,y,sp]);

s.t.  eqTechAfsUp{y in mMidMilestone, t in tech, r in region, s in slice : pTechAfsUp[t,r,y,s] >= 0 and (t,r,y) in mTechSpan}: sum{sp in slice:(((t,sp) in mTechSlice and ((s,sp) in mSameSlice or (s,sp) in mAllSliceParentChild)))}(vTechAct[t,r,y,sp]) <=  pTechAfsUp[t,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (t,wth1) in mTechWeatherAfs and pTechWeatherAfsUp[t,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfsUp[t,wth1]);

s.t.  eqTechActSng{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in (mTechOutComm inter mTechOneComm) : pTechCact2cout[t,c,r,y,s] <> 0}: vTechAct[t,r,y,s]  =  (vTechOut[t,c,r,y,s]) / (pTechCact2cout[t,c,r,y,s]);

s.t.  eqTechActGrp{(t, s) in mTechSlice, y in mMidMilestone, (t, g) in mTechOutGroup, (t, r, y) in mTechSpan : }: vTechAct[t,r,y,s]  =  sum{c in comm:(((t,g,c) in mTechGroupComm and pTechCact2cout[t,c,r,y,s] <> 0))}((vTechOut[t,c,r,y,s]) / (pTechCact2cout[t,c,r,y,s]));

s.t.  eqTechAfcOutLo{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in mTechOutComm : pTechAfcLo[t,c,r,y,s] <> 0}: pTechCact2cout[t,c,r,y,s]*pTechAfcLo[t,c,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and pTechWeatherAfcLo[t,wth1,c] >= 0 and (t,wth1,c) in mTechWeatherAfc and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfcLo[t,wth1,c]) <=  vTechOut[t,c,r,y,s];

s.t.  eqTechAfcOutUp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in mTechOutComm, (t, r, y, s) in mTechAfUp, (t, c, r, y, s) in mTechAfcUp : }: vTechOut[t,c,r,y,s] <=  pTechCact2cout[t,c,r,y,s]*pTechAfcUp[t,c,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and pTechWeatherAfcUp[t,wth1,c] >= 0 and (t,wth1,c) in mTechWeatherAfc and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfcUp[t,wth1,c]);

s.t.  eqTechAfcInpLo{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in mTechInpComm : pTechAfcLo[t,c,r,y,s] <> 0}: pTechAfcLo[t,c,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and pTechWeatherAfcLo[t,wth1,c] >= 0 and (t,wth1,c) in mTechWeatherAfc and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfcLo[t,wth1,c]) <=  vTechInp[t,c,r,y,s];

s.t.  eqTechAfcInpUp{(t, s) in mTechSlice, y in mMidMilestone, (t, r, y) in mTechSpan, (t, c) in mTechInpComm, (t, r, y, s) in mTechAfUp, (t, c, r, y, s) in mTechAfcUp : }: vTechInp[t,c,r,y,s] <=  pTechAfcUp[t,c,r,y,s]*pTechCap2act[t]*vTechCap[t,r,y]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and pTechWeatherAfcUp[t,wth1,c] >= 0 and (t,wth1,c) in mTechWeatherAfc and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pTechWeatherAfcUp[t,wth1,c]);

s.t.  eqTechCap{y in mMidMilestone, (t, r, y) in mTechSpan : }: vTechCap[t,r,y]  =  pTechStock[t,r,y]+sum{yp in year:(((t,r,yp) in mTechNew and yp in mMidMilestone and ordYear[y] >= ordYear[yp] and (ordYear[y]<pTechOlife[t,r]+ordYear[yp] or (t,r) in mTechOlifeInf)))}(vTechNewCap[t,r,yp]-sum{ye in year:((t in mTechRetirement and ye in mMidMilestone and ordYear[ye] >= ordYear[yp] and ordYear[ye] <= ordYear[y]))}(vTechRetiredCap[t,r,yp,ye]));

s.t.  eqTechNewCap{y in mMidMilestone, (t, r, y) in mTechNew, t in mTechRetirement : }: sum{yp in year:((yp in mMidMilestone and ordYear[yp] >= ordYear[y] and ordYear[yp]<ordYear[y]+pTechOlife[t,r]))}(vTechRetiredCap[t,r,y,yp]) <=  vTechNewCap[t,r,y];

s.t.  eqTechEac{y in mMidMilestone, (t, r, y) in mTechSpan : }: vTechEac[t,r,y]  =  sum{yp in year:(((t,r,yp) in mTechNew and yp in mMidMilestone and ordYear[y] >= ordYear[yp] and ordYear[y]<pTechOlife[t,r]+ordYear[yp] and not(((t,r) in mTechOlifeInf)) and pTechInvcost[t,r,yp] <> 0))}((pTechInvcost[t,r,yp]*(vTechNewCap[t,r,yp]-sum{ye in year:((t in mTechRetirement and ye in mMidMilestone and ordYear[ye] >= ordYear[yp] and ordYear[ye] <= ordYear[y]))}(vTechRetiredCap[t,r,yp,ye]))) / ((sum{ye in year:((ordYear[ye] >= ordYear[yp] and ordYear[ye]<ordYear[yp]+pTechOlife[t,r]))}((pDiscountFactor[r,ye]) / (pDiscountFactor[r,yp]))+sum{ye in year:((ordYear[ye]=cardYear[y] and ordYear[ye]<ordYear[yp]+pTechOlife[t,r]-1 and not((r in mDiscountZero))))}((pDiscountFactor[r,ye]*(1-(((1+pDiscount[r,ye]))^(ordYear[ye]-ordYear[yp]-pTechOlife[t,r]+1)))) / (pDiscountFactor[r,yp]*pDiscount[r,ye]))+sum{ye in year:((ordYear[ye]=cardYear[y] and ordYear[ye]<ordYear[yp]+pTechOlife[t,r]-1 and r in mDiscountZero))}((pDiscountFactor[r,ye]*(pTechOlife[t,r]-1-ordYear[ye]+ordYear[yp])) / (pDiscountFactor[r,yp])))));

s.t.  eqTechInv{y in mMidMilestone, (t, r, y) in mTechNew : }: vTechInv[t,r,y]  =  pTechInvcost[t,r,y]*vTechNewCap[t,r,y];

s.t.  eqTechSalv0{r in mDiscountZero, ye in mMilestoneLast, t in tech : sum{y in year:((t,r,y) in mTechNew)}(1) <> 0}: vTechSalv[t,r]+sum{y in year,yn in year:(((yn,y) in mStartMilestone and yn in mMidMilestone and (t,r,yn) in mTechNew and ordYear[yn]+pTechOlife[t,r]-1>ordYear[ye] and not(((t,r) in mTechOlifeInf)) and pTechInvcost[t,r,yn] <> 0))}((((pDiscountFactor[r,yn]) / (pDiscountFactor[r,ye]))*pTechInvcost[t,r,yn]*(vTechNewCap[t,r,yn]-sum{yp in year:((t in mTechRetirement))}(vTechRetiredCap[t,r,y,yp]))) / ((1+((sum{yp in year:((ordYear[yp] >= ordYear[yn]))}(pDiscountFactor[r,yp]))) / ((pDiscountFactor[r,ye])*((pTechOlife[t,r]+ordYear[yn]-1-ordYear[ye]))))))  =  0;

s.t.  eqTechSalv{, t in tech, r in region, ye in year : not((r in mDiscountZero)) and ye in mMilestoneLast and sum{y in year:((t,r,y) in mTechNew)}(1) <> 0}: vTechSalv[t,r]+sum{y in year,yn in year:(((yn,y) in mStartMilestone and yn in mMidMilestone and (t,r,yn) in mTechNew and ordYear[yn]+pTechOlife[t,r]-1>ordYear[ye] and not(((t,r) in mTechOlifeInf)) and pTechInvcost[t,r,yn] <> 0))}((((pDiscountFactor[r,yn]) / (pDiscountFactor[r,ye]))*pTechInvcost[t,r,yn]*(vTechNewCap[t,r,yn]-sum{yp in year:((yp in mMidMilestone and t in mTechRetirement))}(vTechRetiredCap[t,r,y,yp]))) / ((1+((sum{yp in year:((ordYear[yp] >= ordYear[yn]))}(pDiscountFactor[r,yp]))) / (pDiscountFactor[r,ye]*(((1-((1+pDiscount[r,ye]))^(ordYear[ye]-pTechOlife[t,r]-ordYear[yn]+1))*(1+pDiscount[r,ye])) / (pDiscount[r,ye]))))))  =  0;

s.t.  eqTechOMCost{y in mMidMilestone, (t, r, y) in mTechSpan : }: vTechOMCost[t,r,y]  =  pTechFixom[t,r,y]*vTechCap[t,r,y]+sum{s in slice:((t,s) in mTechSlice)}(pTechVarom[t,r,y,s]*vTechAct[t,r,y,s]+sum{c in comm:((t,c) in mTechInpComm)}(pTechCvarom[t,c,r,y,s]*vTechInp[t,c,r,y,s])+sum{c in comm:((t,c) in mTechOutComm)}(pTechCvarom[t,c,r,y,s]*vTechOut[t,c,r,y,s])+sum{c in comm:((t,c) in mTechAOut)}(pTechAvarom[t,c,r,y,s]*vTechAOut[t,c,r,y,s])+sum{c in comm:((t,c) in mTechAInp)}(pTechAvarom[t,c,r,y,s]*vTechAInp[t,c,r,y,s]));

s.t.  eqSupAvaUp{(s1, c, r, y, s) in mSupAvaUp : }: vSupOut[s1,c,r,y,s] <=  pSupAvaUp[s1,c,r,y,s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (s1,wth1) in mSupWeatherUp and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pSupWeatherUp[s1,wth1]);

s.t.  eqSupAvaLo{(s1, c, r, y, s) in mSupAva : }: vSupOut[s1,c,r,y,s]  >=  pSupAvaLo[s1,c,r,y,s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (s1,wth1) in mSupWeatherLo and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pSupWeatherLo[s1,wth1]);
...
s.t.  eqStorageAInp{y in mMidMilestone, (st1, c) in mStorageAInp, (st1, s) in mStorageSlice, (st1, r, y) in mStorageSpan : }: vStorageAInp[st1,c,r,y,s]  =  sum{cp in comm:((st1,cp) in mStorageComm)}(pStorageStg2AInp[st1,c,r,y,s]*vStorageStore[st1,cp,r,y,s]+pStorageInp2AInp[st1,c,r,y,s]*vStorageInp[st1,cp,r,y,s]+pStorageOut2AInp[st1,c,r,y,s]*vStorageOut[st1,cp,r,y,s]+pStorageCap2AInp[st1,c,r,y,s]*vStorageCap[st1,r,y]+pStorageNCap2AInp[st1,c,r,y,s]*vStorageNewCap[st1,r,y]);

s.t.  eqStorageAOut{y in mMidMilestone, (st1, c) in mStorageAOut, (st1, s) in mStorageSlice, (st1, r, y) in mStorageSpan : }: vStorageAOut[st1,c,r,y,s]  =  sum{cp in comm:((st1,cp) in mStorageComm)}(pStorageStg2AOut[st1,c,r,y,s]*vStorageStore[st1,cp,r,y,s]+pStorageInp2AOut[st1,c,r,y,s]*vStorageInp[st1,cp,r,y,s]+pStorageOut2AOut[st1,c,r,y,s]*vStorageOut[st1,cp,r,y,s]+pStorageCap2AOut[st1,c,r,y,s]*vStorageCap[st1,r,y]+pStorageNCap2AOut[st1,c,r,y,s]*vStorageNewCap[st1,r,y]);

s.t.  eqStorageStore{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : }: vStorageStore[st1,c,r,y,s]  =  pStorageInpEff[st1,c,r,y,s]*vStorageInp[st1,c,r,y,s]-(vStorageOut[st1,c,r,y,s]) / (pStorageOutEff[st1,c,r,y,s])+sum{sp in slice:(((st1,sp) in mStorageSlice and (sp,s) in mSliceNext))}(pStorageStgEff[st1,c,r,y,s]*vStorageStore[st1,c,r,y,sp]);

s.t.  eqStorageAfLo{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : pStorageAfLo[st1,r,y,s]}: vStorageStore[st1,c,r,y,s]  >=  pStorageAfLo[st1,r,y,s]*pStorageCap2stg[st1]*vStorageCap[st1,r,y]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherAf and pStorageWeatherAfLo[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherAfLo[st1,wth1]);

s.t.  eqStorageAfUp{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : }: vStorageStore[st1,c,r,y,s] <=  pStorageAfUp[st1,r,y,s]*pStorageCap2stg[st1]*vStorageCap[st1,r,y]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherAf and pStorageWeatherAfUp[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherAfUp[st1,wth1]);

s.t.  eqStorageClean{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : }: vStorageInp[st1,c,r,y,s] <=  vStorageStore[st1,c,r,y,s];

s.t.  eqStorageInpUp{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : pStorageCinpUp[st1,c,r,y,s] >= 0}: pStorageInpEff[st1,c,r,y,s]*vStorageInp[st1,c,r,y,s] <=  pStorageCinpUp[st1,c,r,y,s]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherCinp and pStorageWeatherCinpUp[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherCinpUp[st1,wth1]);

s.t.  eqStorageInpLo{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : pStorageCinpLo[st1,c,r,y,s]>0}: pStorageInpEff[st1,c,r,y,s]*vStorageInp[st1,c,r,y,s]  >=  pStorageCinpLo[st1,c,r,y,s]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherCinp and pStorageWeatherCinpLo[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherCinpLo[st1,wth1]);

s.t.  eqStorageOutUp{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : pStorageCoutUp[st1,c,r,y,s] >= 0}: (vStorageOut[st1,c,r,y,s]) / (pStorageOutEff[st1,c,r,y,s]) <=  pStorageCoutUp[st1,c,r,y,s]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherCout and pStorageWeatherCoutUp[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherCoutUp[st1,wth1]);

s.t.  eqStorageOutLo{(st1, s) in mStorageSlice, y in mMidMilestone, (st1, r, y) in mStorageSpan, (st1, c) in mStorageComm : pStorageCoutLo[st1,c,r,y,s]>0}: (vStorageOut[st1,c,r,y,s]) / (pStorageOutEff[st1,c,r,y,s])  >=  pStorageCoutLo[st1,c,r,y,s]*pSliceShare[s]*prod{sp in slice,wth1 in weather:(((wth1,r) in mWeatherRegion and (wth1,sp) in mWeatherSlice and (st1,wth1) in mStorageWeatherCout and pStorageWeatherCoutLo[st1,wth1] >= 0 and ((s,sp) in mAllSliceParentChild or (s,sp) in mSameSlice)))}(pWeather[wth1,r,y,s]*pStorageWeatherCoutLo[st1,wth1]);

s.t.  eqStorageCap{y in mMidMilestone, (st1, r, y) in mStorageSpan : }: vStorageCap[st1,r,y]  =  pStorageStock[st1,r,y]+sum{yp in year:((ordYear[y] >= ordYear[yp] and ((st1,r) in mStorageOlifeInf or ordYear[y]<pStorageOlife[st1,r]+ordYear[yp]) and (st1,r,y) in mStorageNew))}(vStorageNewCap[st1,r,yp]);

s.t.  eqStorageInv{y in mMidMilestone, (st1, r, y) in mStorageNew : }: vStorageInv[st1,r,y]  =  pStorageInvcost[st1,r,y]*vStorageNewCap[st1,r,y];

s.t.  eqStorageCost{y in mMidMilestone, (st1, r, y) in mStorageSpan : }: vStorageCost[st1,r,y]  =  pStorageFixom[st1,r,y]*vStorageCap[st1,r,y]+sum{c in comm,s in slice:(((st1,s) in mStorageSlice and (st1,c) in mStorageComm))}(pStorageCostInp[st1,r,y,s]*vStorageInp[st1,c,r,y,s]+pStorageCostOut[st1,r,y,s]*vStorageOut[st1,c,r,y,s]+pStorageCostStore[st1,r,y,s]*vStorageStore[st1,c,r,y,s])+sum{FORIF: (st1,r,y) in mStorageNew} (vStorageInv[st1,r,y]);
...
s.t.  eqStorageSalv{, st1 in stg, r in region, ye in year : not((r in mDiscountZero)) and ye in mMilestoneLast and sum{y in year:((st1,r,y) in mStorageNew)}(1) <> 0}: vStorageSalv[st1,r]+sum{y in year,yn in year:(((yn,y) in mStartMilestone and yn in mMidMilestone and (st1,r,yn) in mStorageNew and ordYear[yn]+pStorageOlife[st1,r]-1>ordYear[ye] and not(((st1,r) in mStorageOlifeInf)) and pStorageInvcost[st1,r,yn] <> 0))}((((pDiscountFactor[r,yn]) / (pDiscountFactor[r,ye]))*pStorageInvcost[st1,r,yn]*vStorageNewCap[st1,r,yn]) / ((1+((sum{yp in year:((ordYear[yp] >= ordYear[yn]))}(pDiscountFactor[r,yp]))) / (pDiscountFactor[r,ye]*(((1-((1+pDiscount[r,ye]))^(ordYear[ye]-pStorageOlife[st1,r]-ordYear[yn]+1))*(1+pDiscount[r,ye])) / (pDiscount[r,ye]))))))  =  0;
...
s.t.  eqBalLo{y in mMidMilestone, c in mLoComm, (c, s) in mCommSlice, r in region : }: vBalance[c,r,y,s]  >=  0;

s.t.  eqBalUp{y in mMidMilestone, c in mUpComm, (c, s) in mCommSlice, r in region : }: vBalance[c,r,y,s] <=  0;

s.t.  eqBalFx{y in mMidMilestone, c in mFxComm, (c, s) in mCommSlice, r in region : }: vBalance[c,r,y,s]  =  0;

s.t.  eqBal{y in mMidMilestone, (c, s) in mCommSlice, r in region : }: vBalance[c,r,y,s]  =  vOutTot[c,r,y,s]-vInpTot[c,r,y,s];

s.t.  eqOutTot{y in mMidMilestone, (c, s) in mCommSlice, r in region : }: vOutTot[c,r,y,s]  =  sum{FORIF: (c,r,y,s) in mDummyImport} (vDummyImport[c,r,y,s])+sum{sp in slice:(((s,sp) in mSameSlice or (s,sp) in mAllSliceParentChild))}(sum{FORIF: (c,r,sp) in mSupOutTot} (vSupOutTot[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mEmsFuelTot} (vEmsFuelTot[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mAggOut} (vAggOut[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mTechOutTot} (vTechOutTot[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mStorageOutTot} (vStorageOutTot[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mImport} (vImport[c,r,y,sp])+sum{FORIF: (c,r,y,sp) in mTradeIrAOutTot} (vTradeIrAOutTot[c,r,y,sp]))+sum{sp in slice:(((sp,s) in mAllSliceParentChild and (c,r,y,sp) in mOut2Lo))}(vOut2Lo[c,r,y,sp,s]);
...
s.t.  eqDummyCost{y in mMidMilestone, (c, r, y) in mDummyCost : }: vDummyCost[c,r,y]  =  sum{s in slice:((c,r,y,s) in mDummyImport)}(pDummyImportCost[c,r,y,s]*vDummyImport[c,r,y,s])+sum{s in slice:((c,r,y,s) in mDummyExport)}(pDummyExportCost[c,r,y,s]*vDummyExport[c,r,y,s]);

s.t.  eqCost{y in mMidMilestone, r in region : }: vCost[r,y]  =  sum{t in tech:((t,r,y) in mTechSpan)}(vTechOMCost[t,r,y])+sum{s1 in sup:((s1,r) in mSupSpan)}(vSupCost[s1,r,y])+sum{c in comm:((c,r,y) in mDummyCost)}(vDummyCost[c,r,y])+sum{c in comm:((c,r,y) in mTaxCost)}(vTaxCost[c,r,y])-sum{c in comm:((c,r,y) in mSubsCost)}(vSubsCost[c,r,y])+sum{st1 in stg:((st1,r,y) in mStorageSpan)}(vStorageCost[st1,r,y])+vTradeCost[r,y];

s.t.  eqTaxCost{(c, r, y) in mTaxCost : }: vTaxCost[c,r,y]  =  sum{s in slice}(pTaxCost[c,r,y,s]*vOutTot[c,r,y,s]);

s.t.  eqSubsCost{(c, r, y) in mSubsCost : }: vSubsCost[c,r,y]  =  sum{s in slice}(pSubsCost[c,r,y,s]*vOutTot[c,r,y,s]);

s.t.  eqObjective: vObjective  =  sum{r in region,y in year,yp in year:((y in mMidMilestone and (y,yp) in mStartMilestone))}(pDiscountFactor[r,yp]*sum{t in tech:((t,r,y) in mTechNew)}(vTechInv[t,r,y]))+sum{r in region,y in year:(y in mMidMilestone)}(vCost[r,y]*sum{ye in year,yp in year,yn in year:(((y,yp) in mStartMilestone and (y,ye) in mEndMilestone and ordYear[yn] >= ordYear[yp] and ordYear[yn] <= ordYear[ye]))}(pDiscountFactor[r,yn]))+sum{r in region,y in year,t in tech:((y in mMilestoneLast and sum{yp in year:((t,r,yp) in mTechNew)}(1) <> 0))}(pDiscountFactor[r,y]*vTechSalv[t,r])+sum{r in region,y in year,st1 in stg:((y in mMilestoneLast and sum{yp in year:((st1,r,yp) in mStorageNew)}(1) <> 0))}(pDiscountFactor[r,y]*vStorageSalv[st1,r]);

s.t.  eqLECActivity{r in mLECRegion, (t, r, y) in mTechSpan : }: sum{s in slice:((t,s) in mTechSlice)}(vTechAct[t,r,y,s])  >=  pLECLoACT[r];
...
for {c in comm,r in region,y in year,s in slice,sp in slice : vInp2Lo[c,r,y,s,sp] <> 0} { 
    printf "%s,%s,%s,%s,%s,%f\n", c,r,y,s,sp, vInp2Lo[c,r,y,s,sp] >> "vInp2Lo.csv";
} 
printf "comm,region,year,slice,slicep,value\n" > "vOut2Lo.csv";
for {c in comm,r in region,y in year,s in slice,sp in slice : vOut2Lo[c,r,y,s,sp] <> 0} { 
