...
s.t.  eqSupOutTot{(c, r, y, s) in mSupOutTot : y in mMidMilestone}: vSupOutTot[c,r,y,s]  =  sum{s1 in sup,sp in slice:(((c,s,sp) in mCommSliceOrParent and (s1,c,r,y,sp) in mSupAva))}(vSupOut[s1,c,r,y,sp]);
