...
scen_BASE_gams <- write_model(
  scen_BASE_int, solver = "GAMS", 
  tmp.dir = "solwork/UTOPIA_BASE_GAMS")
scen_BASE_gams@misc$tmp.dir # directory

scen_BASE_py <- write(scen_BASE_int, solver = "PYOMO", 
                      tmp.dir = "solwork/UTOPIA_BASE_PYOMO")
scen_BASE_py@misc$tmp.dir

scen_BASE_glpk <- write(scen_BASE_int, solver = "GLPK", 
                        tmp.dir = "solwork/UTOPIA_BASE_GLPK")

scen_BASE_jl <- write(scen_BASE_int, solver = "JuMP", 
...
## Solving the model
solve_model(tmp.dir = "solwork/UTOPIA_REN", wait = TRUE)
