...
scen_BASE_gams <- write(
  ...
  # solver = "GAMS",
  solver = GAMS_csv,
  tmp.dir = "tmp/solwork/UTOPIA_BASE_GAMS"
)
scen_BASE_gams@misc$tmp.dir # directory

scen_BASE_py <- write(scen_BASE_int,
  solver = "PYOMO",
  tmp.dir = "tmp/solwork/UTOPIA_BASE_PYOMO"
)
...
system("c:/utils/ffmpeg/4.3.1/bin/ffmpeg -r 4 -f image2 -s 1920x1080 -i Rplot%d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p -y utopia_example_trade.mp4")
