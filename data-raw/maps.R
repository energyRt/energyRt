...
.equation_description = c(
  ...
  eqTechRampUp = "Technology ramp up factor",
  eqTechRampDown = "Technology ramp down factor",
...
.parameter_description = c(
  ...
  pTechRampUp = "Ramp Up for activity for each slice",
  pTechRampDown = "Ramp Down for activity for each slice",
