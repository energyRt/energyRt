...
@constraint(model, [(t, c, r, y, s) in mvTechAInp], vTechAInp[(t,c,r,y,s)]  ==  (if (t,c,r,y,s) in mTechAct2AInp; (vTechAct[(t,r,y,s)]*(if haskey(pTechAct2AInp, (t,c,r,y,s)); pTechAct2AInp[(t,c,r,y,s)]; else pTechAct2AInpDef; end)); else 0; end;)+(if (t,c,r,y,s) in mTechCap2AInp; (vTechCap[(t,r,y)]*(if haskey(pTechCap2AInp, (t,c,r,y,s)); pTechCap2AInp[(t,c,r,y,s)]; else pTechCap2AInpDef; end)); else 0; end;)+(if (t,c,r,y,s) in mTechNCap2AInp; (vTechNewCap[(t,r,y)]*(if haskey(pTechNCap2AInp, (t,c,r,y,s)); pTechNCap2AInp[(t,c,r,y,s)]; else pTechNCap2AInpDef; end)); else 0; end;)+sum((if haskey(pTechCinp2AInp, (t,c,cp,r,y,s)); pTechCinp2AInp[(t,c,cp,r,y,s)]; else pTechCinp2AInpDef; end)*vTechInp[(t,cp,r,y,s)] for cp in comm if (t,c,cp,r,y,s) in mTechCinp2AInp)+sum((if haskey(pTechCout2AInp, (t,c,cp,r,y,s)); pTechCout2AInp[(t,c,cp,r,y,s)]; else pTechCout2AInpDef; end)*vTechOut[(t,cp,r,y,s)] for cp in comm if (t,c,cp,r,y,s) in mTechCout2AInp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, c, r, y, s) in mvTechAOut], vTechAOut[(t,c,r,y,s)]  ==  (if (t,c,r,y,s) in mTechAct2AOut; (vTechAct[(t,r,y,s)]*(if haskey(pTechAct2AOut, (t,c,r,y,s)); pTechAct2AOut[(t,c,r,y,s)]; else pTechAct2AOutDef; end)); else 0; end;)+(if (t,c,r,y,s) in mTechCap2AOut; (vTechCap[(t,r,y)]*(if haskey(pTechCap2AOut, (t,c,r,y,s)); pTechCap2AOut[(t,c,r,y,s)]; else pTechCap2AOutDef; end)); else 0; end;)+(if (t,c,r,y,s) in mTechNCap2AOut; (vTechNewCap[(t,r,y)]*(if haskey(pTechNCap2AOut, (t,c,r,y,s)); pTechNCap2AOut[(t,c,r,y,s)]; else pTechNCap2AOutDef; end)); else 0; end;)+sum((if haskey(pTechCinp2AOut, (t,c,cp,r,y,s)); pTechCinp2AOut[(t,c,cp,r,y,s)]; else pTechCinp2AOutDef; end)*vTechInp[(t,cp,r,y,s)] for cp in comm if (t,c,cp,r,y,s) in mTechCinp2AOut)+sum((if haskey(pTechCout2AOut, (t,c,cp,r,y,s)); pTechCout2AOut[(t,c,cp,r,y,s)]; else pTechCout2AOutDef; end)*vTechOut[(t,cp,r,y,s)] for cp in comm if (t,c,cp,r,y,s) in mTechCout2AOut)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechAfLo(tech, region, year, slice)$meqTechAfLo(tech, region, year, slice)
print("eqTechAfLo(tech, region, year, slice)...")
@constraint(model, [(t, r, y, s) in meqTechAfLo], (if haskey(pTechAfLo, (t,r,y,s)); pTechAfLo[(t,r,y,s)]; else pTechAfLoDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfLo, (wth1,t)); pTechWeatherAfLo[(wth1,t)]; else pTechWeatherAfLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t) in mTechWeatherAfLo) <=  vTechAct[(t,r,y,s)]); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechAfUp(tech, region, year, slice)$meqTechAfUp(tech, region, year, slice)
print("eqTechAfUp(tech, region, year, slice)...")
@constraint(model, [(t, r, y, s) in meqTechAfUp], vTechAct[(t,r,y,s)] <=  (if haskey(pTechAfUp, (t,r,y,s)); pTechAfUp[(t,r,y,s)]; else pTechAfUpDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfUp, (wth1,t)); pTechWeatherAfUp[(wth1,t)]; else pTechWeatherAfUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t) in mTechWeatherAfUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechAfsLo(tech, region, year, slice)$meqTechAfsLo(tech, region, year, slice)
print("eqTechAfsLo(tech, region, year, slice)...")
@constraint(model, [(t, r, y, s) in meqTechAfsLo], (if haskey(pTechAfsLo, (t,r,y,s)); pTechAfsLo[(t,r,y,s)]; else pTechAfsLoDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfsLo, (wth1,t)); pTechWeatherAfsLo[(wth1,t)]; else pTechWeatherAfsLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t) in mTechWeatherAfsLo) <=  sum((if (t,r,y,sp) in mvTechAct; vTechAct[(t,r,y,sp)]; else 0; end;) for sp in slice if (s,sp) in mSliceParentChildE)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechAfsUp(tech, region, year, slice)$meqTechAfsUp(tech, region, year, slice)
print("eqTechAfsUp(tech, region, year, slice)...")
@constraint(model, [(t, r, y, s) in meqTechAfsUp], sum((if (t,r,y,sp) in mvTechAct; vTechAct[(t,r,y,sp)]; else 0; end;) for sp in slice if (s,sp) in mSliceParentChildE) <=  (if haskey(pTechAfsUp, (t,r,y,s)); pTechAfsUp[(t,r,y,s)]; else pTechAfsUpDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfsUp, (wth1,t)); pTechWeatherAfsUp[(wth1,t)]; else pTechWeatherAfsUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t) in mTechWeatherAfsUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, y, s, sp) in mTechRampUp], (vTechAct[(t,r,y,s)]) / ((if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end))-(vTechAct[(t,r,y,sp)]) / ((if haskey(pSliceShare, (sp)); pSliceShare[(sp)]; else pSliceShareDef; end)) <=  ((if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]) / ((if haskey(pTechRampUp, (t,r,y,s)); pTechRampUp[(t,r,y,s)]; else pTechRampUpDef; end))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, y, s, sp) in mTechRampDown], (vTechAct[(t,r,y,sp)]) / ((if haskey(pSliceShare, (sp)); pSliceShare[(sp)]; else pSliceShareDef; end))-(vTechAct[(t,r,y,s)]) / ((if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)) <=  ((if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]) / ((if haskey(pTechRampDown, (t,r,y,s)); pTechRampDown[(t,r,y,s)]; else pTechRampDownDef; end))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, c, y, s) in meqTechAfcOutLo], (if haskey(pTechCact2cout, (t,c,r,y,s)); pTechCact2cout[(t,c,r,y,s)]; else pTechCact2coutDef; end)*(if haskey(pTechAfcLo, (t,c,r,y,s)); pTechAfcLo[(t,c,r,y,s)]; else pTechAfcLoDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfcLo, (wth1,t,c)); pTechWeatherAfcLo[(wth1,t,c)]; else pTechWeatherAfcLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t,c) in mTechWeatherAfcLo) <=  vTechOut[(t,c,r,y,s)]); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, c, y, s) in meqTechAfcOutUp], vTechOut[(t,c,r,y,s)] <=  (if haskey(pTechCact2cout, (t,c,r,y,s)); pTechCact2cout[(t,c,r,y,s)]; else pTechCact2coutDef; end)*(if haskey(pTechAfcUp, (t,c,r,y,s)); pTechAfcUp[(t,c,r,y,s)]; else pTechAfcUpDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*prod((if haskey(pTechWeatherAfcUp, (wth1,t,c)); pTechWeatherAfcUp[(wth1,t,c)]; else pTechWeatherAfcUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t,c) in mTechWeatherAfcUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, c, y, s) in meqTechAfcInpLo], (if haskey(pTechAfcLo, (t,c,r,y,s)); pTechAfcLo[(t,c,r,y,s)]; else pTechAfcLoDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfcLo, (wth1,t,c)); pTechWeatherAfcLo[(wth1,t,c)]; else pTechWeatherAfcLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t,c) in mTechWeatherAfcLo) <=  vTechInp[(t,c,r,y,s)]); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, c, y, s) in meqTechAfcInpUp], vTechInp[(t,c,r,y,s)] <=  (if haskey(pTechAfcUp, (t,c,r,y,s)); pTechAfcUp[(t,c,r,y,s)]; else pTechAfcUpDef; end)*(if haskey(pTechCap2act, (t)); pTechCap2act[(t)]; else pTechCap2actDef; end)*vTechCap[(t,r,y)]*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pTechWeatherAfcUp, (wth1,t,c)); pTechWeatherAfcUp[(wth1,t,c)]; else pTechWeatherAfcUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,t,c) in mTechWeatherAfcUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechCap(tech, region, year)$mTechSpan(tech, region, year)
print("eqTechCap(tech, region, year)...")
@constraint(model, [(t, r, y) in mTechSpan], vTechCap[(t,r,y)]  ==  (if haskey(pTechStock, (t,r,y)); pTechStock[(t,r,y)]; else pTechStockDef; end)-(if (t,r,y) in mvTechRetiredStock; vTechRetiredStock[(t,r,y)]; else 0; end;)+sum((if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*(vTechNewCap[(t,r,yp)]-sum(vTechRetiredNewCap[(t,r,yp,ye)] for ye in year if ((t,r,yp,ye) in mvTechRetiredNewCap && ordYear[(y)] >= ordYear[(ye)]))) for yp in year if ((t,r,yp) in mTechNew && ordYear[(y)] >= ordYear[(yp)] && (ordYear[(y)]<(if haskey(pTechOlife, (t,r)); pTechOlife[(t,r)]; else pTechOlifeDef; end)+ordYear[(yp)] || (t,r) in mTechOlifeInf)))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechRetiredNewCap(tech, region, year)$meqTechRetiredNewCap(tech, region, year)
print("eqTechRetiredNewCap(tech, region, year)...")
@constraint(model, [(t, r, y) in meqTechRetiredNewCap], sum(vTechRetiredNewCap[(t,r,y,yp)] for yp in year if (t,r,y,yp) in mvTechRetiredNewCap) <=  vTechNewCap[(t,r,y)]); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechRetiredStock(tech, region, year)$mvTechRetiredStock(tech, region, year)
print("eqTechRetiredStock(tech, region, year)...")
@constraint(model, [(t, r, y) in mvTechRetiredStock], vTechRetiredStock[(t,r,y)] <=  (if haskey(pTechStock, (t,r,y)); pTechStock[(t,r,y)]; else pTechStockDef; end)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechEac(tech, region, year)$mTechEac(tech, region, year)
print("eqTechEac(tech, region, year)...")
@constraint(model, [(t, r, y) in mTechEac], vTechEac[(t,r,y)]  ==  sum((if haskey(pTechEac, (t,r,yp)); pTechEac[(t,r,yp)]; else pTechEacDef; end)*(if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*(vTechNewCap[(t,r,yp)]-sum(vTechRetiredNewCap[(t,r,yp,ye)] for ye in year if ((t,r,yp,ye) in mvTechRetiredNewCap && ordYear[(y)] >= ordYear[(ye)]))) for yp in year if ((t,r,yp) in mTechNew && ordYear[(y)] >= ordYear[(yp)] && (ordYear[(y)]<(if haskey(pTechOlife, (t,r)); pTechOlife[(t,r)]; else pTechOlifeDef; end)+ordYear[(yp)] || (t,r) in mTechOlifeInf)))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t, r, y) in mTechOMCost], vTechOMCost[(t,r,y)]  ==  (if haskey(pTechFixom, (t,r,y)); pTechFixom[(t,r,y)]; else pTechFixomDef; end)*vTechCap[(t,r,y)]+sum((if haskey(pTechVarom, (t,r,y,s)); pTechVarom[(t,r,y,s)]; else pTechVaromDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vTechAct[(t,r,y,s)]+sum((if haskey(pTechCvarom, (t,c,r,y,s)); pTechCvarom[(t,c,r,y,s)]; else pTechCvaromDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vTechInp[(t,c,r,y,s)] for c in comm if (t,c) in mTechInpComm)+sum((if haskey(pTechCvarom, (t,c,r,y,s)); pTechCvarom[(t,c,r,y,s)]; else pTechCvaromDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vTechOut[(t,c,r,y,s)] for c in comm if (t,c) in mTechOutComm)+sum((if haskey(pTechAvarom, (t,c,r,y,s)); pTechAvarom[(t,c,r,y,s)]; else pTechAvaromDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vTechAOut[(t,c,r,y,s)] for c in comm if (t,c,r,y,s) in mvTechAOut)+sum((if haskey(pTechAvarom, (t,c,r,y,s)); pTechAvarom[(t,c,r,y,s)]; else pTechAvaromDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vTechAInp[(t,c,r,y,s)] for c in comm if (t,c,r,y,s) in mvTechAInp) for s in slice if (t,s) in mTechSlice)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqSupAvaUp(sup, comm, region, year, slice)$mSupAvaUp(sup, comm, region, year, slice)
print("eqSupAvaUp(sup, comm, region, year, slice)...")
@constraint(model, [(s1, c, r, y, s) in mSupAvaUp], vSupOut[(s1,c,r,y,s)] <=  (if haskey(pSupAvaUp, (s1,c,r,y,s)); pSupAvaUp[(s1,c,r,y,s)]; else pSupAvaUpDef; end)*prod((if haskey(pSupWeatherUp, (wth1,s1)); pSupWeatherUp[(wth1,s1)]; else pSupWeatherUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,s1) in mSupWeatherUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqSupAvaLo(sup, comm, region, year, slice)$meqSupAvaLo(sup, comm, region, year, slice)
print("eqSupAvaLo(sup, comm, region, year, slice)...")
@constraint(model, [(s1, c, r, y, s) in meqSupAvaLo], vSupOut[(s1,c,r,y,s)]  >=  (if haskey(pSupAvaLo, (s1,c,r,y,s)); pSupAvaLo[(s1,c,r,y,s)]; else pSupAvaLoDef; end)*prod((if haskey(pSupWeatherLo, (wth1,s1)); pSupWeatherLo[(wth1,s1)]; else pSupWeatherLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,s1) in mSupWeatherLo)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqSupTotal(sup, comm, region)$mvSupReserve(sup, comm, region)
print("eqSupTotal(sup, comm, region)...")
@constraint(model, [(s1, c, r) in mvSupReserve], vSupReserve[(s1,c,r)]  ==  sum((if haskey(pPeriodLen, (y)); pPeriodLen[(y)]; else pPeriodLenDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vSupOut[(s1,c,r,y,s)] for y in year for s in slice if (s1,c,r,y,s) in mSupAva)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqSupReserveUp(sup, comm, region)$mSupReserveUp(sup, comm, region)
print("eqSupReserveUp(sup, comm, region)...")
@constraint(model, [(s1, c, r) in mSupReserveUp], vSupReserve[(s1,c,r)] <=  (if haskey(pSupReserveUp, (s1,c,r)); pSupReserveUp[(s1,c,r)]; else pSupReserveUpDef; end)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(s1, r, y) in mvSupCost], vSupCost[(s1,r,y)]  ==  sum((if haskey(pSupCost, (s1,c,r,y,s)); pSupCost[(s1,c,r,y,s)]; else pSupCostDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vSupOut[(s1,c,r,y,s)] for c in comm for s in slice if (s1,c,r,y,s) in mSupAva)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(c, r, y, s) in mAggOut], vAggOutTot[(c,r,y,s)]  ==  sum((if haskey(pAggregateFactor, (c,cp)); pAggregateFactor[(c,cp)]; else pAggregateFactorDef; end)*sum(vOutTot[(cp,r,y,sp)] for sp in slice if ((c,r,y,sp) in mvOutTot && (s,sp) in mSliceParentChildE && (cp,sp) in mCommSlice)) for cp in comm if (c,cp) in mAggregateFactor)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqEmsFuelTot(comm, region, year, slice)$mEmsFuelTot(comm, region, year, slice)
print("eqEmsFuelTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mEmsFuelTot], vEmsFuelTot[(c,r,y,s)]  ==  sum((if haskey(pEmissionFactor, (c,cp)); pEmissionFactor[(c,cp)]; else pEmissionFactorDef; end)*sum((if haskey(pTechEmisComm, (t,cp)); pTechEmisComm[(t,cp)]; else pTechEmisCommDef; end)*sum((if (t,c,cp,r,y,sp) in mTechEmsFuel; vTechInp[(t,cp,r,y,sp)]; else 0; end;) for sp in slice if (c,s,sp) in mCommSliceOrParent) for t in tech if (t,cp) in mTechInpComm) for cp in comm if ((if haskey(pEmissionFactor, (c,cp)); pEmissionFactor[(c,cp)]; else pEmissionFactorDef; end)>0))*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in mvStorageAInp], vStorageAInp[(st1,c,r,y,s)]  ==  sum((if (st1,c,r,y,s) in mStorageStg2AInp; ((if haskey(pStorageStg2AInp, (st1,c,r,y,s)); pStorageStg2AInp[(st1,c,r,y,s)]; else pStorageStg2AInpDef; end)*vStorageStore[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCinp2AInp; ((if haskey(pStorageCinp2AInp, (st1,c,r,y,s)); pStorageCinp2AInp[(st1,c,r,y,s)]; else pStorageCinp2AInpDef; end)*vStorageInp[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCout2AInp; ((if haskey(pStorageCout2AInp, (st1,c,r,y,s)); pStorageCout2AInp[(st1,c,r,y,s)]; else pStorageCout2AInpDef; end)*vStorageOut[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCap2AInp; ((if haskey(pStorageCap2AInp, (st1,c,r,y,s)); pStorageCap2AInp[(st1,c,r,y,s)]; else pStorageCap2AInpDef; end)*vStorageCap[(st1,r,y)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageNCap2AInp; ((if haskey(pStorageNCap2AInp, (st1,c,r,y,s)); pStorageNCap2AInp[(st1,c,r,y,s)]; else pStorageNCap2AInpDef; end)*vStorageNewCap[(st1,r,y)]); else 0; end;) for cp in comm if (st1,cp) in mStorageComm)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in mvStorageAOut], vStorageAOut[(st1,c,r,y,s)]  ==  sum((if (st1,c,r,y,s) in mStorageStg2AOut; ((if haskey(pStorageStg2AOut, (st1,c,r,y,s)); pStorageStg2AOut[(st1,c,r,y,s)]; else pStorageStg2AOutDef; end)*vStorageStore[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCinp2AOut; ((if haskey(pStorageCinp2AOut, (st1,c,r,y,s)); pStorageCinp2AOut[(st1,c,r,y,s)]; else pStorageCinp2AOutDef; end)*vStorageInp[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCout2AOut; ((if haskey(pStorageCout2AOut, (st1,c,r,y,s)); pStorageCout2AOut[(st1,c,r,y,s)]; else pStorageCout2AOutDef; end)*vStorageOut[(st1,cp,r,y,s)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageCap2AOut; ((if haskey(pStorageCap2AOut, (st1,c,r,y,s)); pStorageCap2AOut[(st1,c,r,y,s)]; else pStorageCap2AOutDef; end)*vStorageCap[(st1,r,y)]); else 0; end;)+(if (st1,c,r,y,s) in mStorageNCap2AOut; ((if haskey(pStorageNCap2AOut, (st1,c,r,y,s)); pStorageNCap2AOut[(st1,c,r,y,s)]; else pStorageNCap2AOutDef; end)*vStorageNewCap[(st1,r,y)]); else 0; end;) for cp in comm if (st1,cp) in mStorageComm)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqStorageStore(stg, comm, region, year, slice)$mvStorageStore(stg, comm, region, year, slice)
print("eqStorageStore(stg, comm, region, year, slice)...")
@constraint(model, [(st1, c, r, y, s) in mvStorageStore], vStorageStore[(st1,c,r,y,s)]  ==  (if haskey(pStorageCharge, (st1,c,r,y,s)); pStorageCharge[(st1,c,r,y,s)]; else pStorageChargeDef; end)+(if (st1,r,y) in mStorageNew; ((if haskey(pStorageNCap2Stg, (st1,c,r,y,s)); pStorageNCap2Stg[(st1,c,r,y,s)]; else pStorageNCap2StgDef; end)*vStorageNewCap[(st1,r,y)]); else 0; end;)+sum((if haskey(pStorageInpEff, (st1,c,r,y,sp)); pStorageInpEff[(st1,c,r,y,sp)]; else pStorageInpEffDef; end)*vStorageInp[(st1,c,r,y,sp)]+(((if haskey(pStorageStgEff, (st1,c,r,y,s)); pStorageStgEff[(st1,c,r,y,s)]; else pStorageStgEffDef; end))^((if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)))*vStorageStore[(st1,c,r,y,sp)]-(vStorageOut[(st1,c,r,y,sp)]) / ((if haskey(pStorageOutEff, (st1,c,r,y,sp)); pStorageOutEff[(st1,c,r,y,sp)]; else pStorageOutEffDef; end)) for sp in slice if ((c,sp) in mCommSlice && ((!((st1 in mStorageFullYear)) && (sp,s) in mSliceNext) || (st1 in mStorageFullYear && (sp,s) in mSliceFYearNext))))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageAfLo], vStorageStore[(st1,c,r,y,s)]  >=  (if haskey(pStorageAfLo, (st1,r,y,s)); pStorageAfLo[(st1,r,y,s)]; else pStorageAfLoDef; end)*(if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*prod((if haskey(pStorageWeatherAfLo, (wth1,st1)); pStorageWeatherAfLo[(wth1,st1)]; else pStorageWeatherAfLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherAfLo)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageAfUp], vStorageStore[(st1,c,r,y,s)] <=  (if haskey(pStorageAfUp, (st1,r,y,s)); pStorageAfUp[(st1,r,y,s)]; else pStorageAfUpDef; end)*(if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*prod((if haskey(pStorageWeatherAfUp, (wth1,st1)); pStorageWeatherAfUp[(wth1,st1)]; else pStorageWeatherAfUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherAfUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageInpUp], vStorageInp[(st1,c,r,y,s)] <=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCinpUp, (st1,c,r,y,s)); pStorageCinpUp[(st1,c,r,y,s)]; else pStorageCinpUpDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCinpUp, (wth1,st1)); pStorageWeatherCinpUp[(wth1,st1)]; else pStorageWeatherCinpUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherCinpUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageInpLo], vStorageInp[(st1,c,r,y,s)]  >=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCinpLo, (st1,c,r,y,s)); pStorageCinpLo[(st1,c,r,y,s)]; else pStorageCinpLoDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCinpLo, (wth1,st1)); pStorageWeatherCinpLo[(wth1,st1)]; else pStorageWeatherCinpLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherCinpLo)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageOutUp], vStorageOut[(st1,c,r,y,s)] <=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCoutUp, (st1,c,r,y,s)); pStorageCoutUp[(st1,c,r,y,s)]; else pStorageCoutUpDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCoutUp, (wth1,st1)); pStorageWeatherCoutUp[(wth1,st1)]; else pStorageWeatherCoutUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherCoutUp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, c, r, y, s) in meqStorageOutLo], vStorageOut[(st1,c,r,y,s)]  >=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCoutLo, (st1,c,r,y,s)); pStorageCoutLo[(st1,c,r,y,s)]; else pStorageCoutLoDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCoutLo, (wth1,st1)); pStorageWeatherCoutLo[(wth1,st1)]; else pStorageWeatherCoutLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1) in mStorageWeatherCoutLo)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqStorageCap(stg, region, year)$mStorageSpan(stg, region, year)
print("eqStorageCap(stg, region, year)...")
@constraint(model, [(st1, r, y) in mStorageSpan], vStorageCap[(st1,r,y)]  ==  (if haskey(pStorageStock, (st1,r,y)); pStorageStock[(st1,r,y)]; else pStorageStockDef; end)+sum((if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*vStorageNewCap[(st1,r,yp)] for yp in year if (ordYear[(y)] >= ordYear[(yp)] && ((st1,r) in mStorageOlifeInf || ordYear[(y)]<(if haskey(pStorageOlife, (st1,r)); pStorageOlife[(st1,r)]; else pStorageOlifeDef; end)+ordYear[(yp)]) && (st1,r,yp) in mStorageNew))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(st1, r, y) in mStorageEac], vStorageEac[(st1,r,y)]  ==  sum((if haskey(pStorageEac, (st1,r,yp)); pStorageEac[(st1,r,yp)]; else pStorageEacDef; end)*(if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*vStorageNewCap[(st1,r,yp)] for yp in year if ((st1,r,yp) in mStorageNew && ordYear[(y)] >= ordYear[(yp)] && ((st1,r) in mStorageOlifeInf || ordYear[(y)]<(if haskey(pStorageOlife, (st1,r)); pStorageOlife[(st1,r)]; else pStorageOlifeDef; end)+ordYear[(yp)]) && (if haskey(pStorageInvcost, (st1,r,yp)); pStorageInvcost[(st1,r,yp)]; else pStorageInvcostDef; end) != 0))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqStorageCost(stg, region, year)$mStorageOMCost(stg, region, year)
print("eqStorageCost(stg, region, year)...")
@constraint(model, [(st1, r, y) in mStorageOMCost], vStorageOMCost[(st1,r,y)]  ==  (if haskey(pStorageFixom, (st1,r,y)); pStorageFixom[(st1,r,y)]; else pStorageFixomDef; end)*vStorageCap[(st1,r,y)]+sum(sum((if haskey(pStorageCostInp, (st1,r,y,s)); pStorageCostInp[(st1,r,y,s)]; else pStorageCostInpDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vStorageInp[(st1,c,r,y,s)]+(if haskey(pStorageCostOut, (st1,r,y,s)); pStorageCostOut[(st1,r,y,s)]; else pStorageCostOutDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vStorageOut[(st1,c,r,y,s)]+(if haskey(pStorageCostStore, (st1,r,y,s)); pStorageCostStore[(st1,r,y,s)]; else pStorageCostStoreDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vStorageStore[(st1,c,r,y,s)] for s in slice if (c,s) in mCommSlice) for c in comm if (st1,c) in mStorageComm)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqImport(comm, dst, year, slice)$mImport(comm, dst, year, slice)
print("eqImport(comm, dst, year, slice)...")
@constraint(model, [(c, dst, y, s) in mImport], vImportTot[(c,dst,y,s)]  ==  sum(sum(sum((if (t1,c,src,dst,y,sp) in mvTradeIr; ((if haskey(pTradeIrEff, (t1,src,dst,y,sp)); pTradeIrEff[(t1,src,dst,y,sp)]; else pTradeIrEffDef; end)*vTradeIr[(t1,c,src,dst,y,sp)]); else 0; end;) for src in region if (t1,src,dst) in mTradeRoutes) for t1 in trade if (t1,c) in mTradeComm) for sp in slice if (c,s,sp) in mCommSliceOrParent)+sum(sum((if (i,c,dst,y,sp) in mImportRow; vImportRow[(i,c,dst,y,sp)]; else 0; end;) for i in imp if (i,c) in mImpComm) for sp in slice if (c,s,sp) in mCommSliceOrParent)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqExport(comm, src, year, slice)$mExport(comm, src, year, slice)
print("eqExport(comm, src, year, slice)...")
@constraint(model, [(c, src, y, s) in mExport], vExportTot[(c,src,y,s)]  ==  sum(sum(sum((if (t1,c,src,dst,y,sp) in mvTradeIr; vTradeIr[(t1,c,src,dst,y,sp)]; else 0; end;) for dst in region if (t1,src,dst) in mTradeRoutes) for t1 in trade if (t1,c) in mTradeComm) for sp in slice if (c,s,sp) in mCommSliceOrParent)+sum(sum((if (e,c,src,y,sp) in mExportRow; vExportRow[(e,c,src,y,sp)]; else 0; end;) for e in expp if (e,c) in mExpComm) for sp in slice if (c,s,sp) in mCommSliceOrParent)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t1, y) in mTradeSpan], vTradeCap[(t1,y)]  ==  (if haskey(pTradeStock, (t1,y)); pTradeStock[(t1,y)]; else pTradeStockDef; end)+sum((if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*vTradeNewCap[(t1,yp)] for yp in year if ((t1,yp) in mTradeNew && ordYear[(y)] >= ordYear[(yp)] && (ordYear[(y)]<(if haskey(pTradeOlife, (t1)); pTradeOlife[(t1)]; else pTradeOlifeDef; end)+ordYear[(yp)] || t1 in mTradeOlifeInf)))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t1, r, y) in mTradeEac], vTradeEac[(t1,r,y)]  ==  sum((if haskey(pTradeEac, (t1,r,yp)); pTradeEac[(t1,r,yp)]; else pTradeEacDef; end)*(if haskey(pPeriodLen, (yp)); pPeriodLen[(yp)]; else pPeriodLenDef; end)*vTradeNewCap[(t1,yp)] for yp in year if ((t1,yp) in mTradeNew && ordYear[(y)] >= ordYear[(yp)] && (ordYear[(y)]<(if haskey(pTradeOlife, (t1)); pTradeOlife[(t1)]; else pTradeOlifeDef; end)+ordYear[(yp)] || t1 in mTradeOlifeInf)))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t1, c, r, y, s) in mvTradeIrAInp], vTradeIrAInp[(t1,c,r,y,s)]  ==  sum((if haskey(pTradeIrCsrc2Ainp, (t1,c,r,dst,y,s)); pTradeIrCsrc2Ainp[(t1,c,r,dst,y,s)]; else pTradeIrCsrc2AinpDef; end)*sum(vTradeIr[(t1,cp,r,dst,y,s)] for cp in comm if (t1,cp) in mTradeComm) for dst in region if (t1,c,r,dst,y,s) in mTradeIrCsrc2Ainp)+sum((if haskey(pTradeIrCdst2Ainp, (t1,c,src,r,y,s)); pTradeIrCdst2Ainp[(t1,c,src,r,y,s)]; else pTradeIrCdst2AinpDef; end)*sum(vTradeIr[(t1,cp,src,r,y,s)] for cp in comm if (t1,cp) in mTradeComm) for src in region if (t1,c,src,r,y,s) in mTradeIrCdst2Ainp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(t1, c, r, y, s) in mvTradeIrAOut], vTradeIrAOut[(t1,c,r,y,s)]  ==  sum((if haskey(pTradeIrCsrc2Aout, (t1,c,r,dst,y,s)); pTradeIrCsrc2Aout[(t1,c,r,dst,y,s)]; else pTradeIrCsrc2AoutDef; end)*sum(vTradeIr[(t1,cp,r,dst,y,s)] for cp in comm if (t1,cp) in mTradeComm) for dst in region if (t1,c,r,dst,y,s) in mTradeIrCsrc2Aout)+sum((if haskey(pTradeIrCdst2Aout, (t1,c,src,r,y,s)); pTradeIrCdst2Aout[(t1,c,src,r,y,s)]; else pTradeIrCdst2AoutDef; end)*sum(vTradeIr[(t1,cp,src,r,y,s)] for cp in comm if (t1,cp) in mTradeComm) for src in region if (t1,c,src,r,y,s) in mTradeIrCdst2Aout)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(c, r, y, s) in mvTradeIrAInpTot], vTradeIrAInpTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vTradeIrAInp[(t1,c,r,y,sp)] for t1 in trade for sp in slice if ((c,s,sp) in mCommSliceOrParent && (t1,c,r,y,sp) in mvTradeIrAInp))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(c, r, y, s) in mvTradeIrAOutTot], vTradeIrAOutTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vTradeIrAOut[(t1,c,r,y,sp)] for t1 in trade for sp in slice if ((c,s,sp) in mCommSliceOrParent && (t1,c,r,y,sp) in mvTradeIrAOut))); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
...
@constraint(model, [(c, r, y, s) in mvOutTot], vOutTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mDummyImport; vDummyImport[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mSupOutTot; vSupOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mEmsFuelTot; vEmsFuelTot[(c,r,y,s)]; else 0; end;)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mAggOut; vAggOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mTechOutTot; vTechOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mStorageOutTot; vStorageOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mImport; vImportTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mvTradeIrAOutTot; vTradeIrAOutTot[(c,r,y,s)]; else 0; end;)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mOutSub; sum(vOut2Lo[(c,r,y,sp,s)] for sp in slice if ((sp,s) in mSliceParentChild && (c,r,y,sp,s) in mvOut2Lo)); else 0; end;)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqOut2Lo(comm, region, year, slice)$mOut2Lo(comm, region, year, slice)
print("eqOut2Lo(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mOut2Lo], sum(vOut2Lo[(c,r,y,s,sp)] for sp in slice if (c,r,y,s,sp) in mvOut2Lo)  ==  (if (c,r,y,s) in mSupOutTot; vSupOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mEmsFuelTot; vEmsFuelTot[(c,r,y,s)]; else 0; end;)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mAggOut; vAggOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mTechOutTot; vTechOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mStorageOutTot; vStorageOutTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mImport; vImportTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mvTradeIrAOutTot; vTradeIrAOutTot[(c,r,y,s)]; else 0; end;)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqInpTot(comm, region, year, slice)$mvInpTot(comm, region, year, slice)
print("eqInpTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mvInpTot], vInpTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mvDemInp; vDemInp[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mDummyExport; vDummyExport[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mTechInpTot; vTechInpTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mStorageInpTot; vStorageInpTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mExport; vExportTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mvTradeIrAInpTot; vTradeIrAInpTot[(c,r,y,s)]; else 0; end;)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*(if (c,r,y,s) in mInpSub; sum(vInp2Lo[(c,r,y,sp,s)] for sp in slice if ((sp,s) in mSliceParentChild && (c,r,y,sp,s) in mvInp2Lo)); else 0; end;)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqInp2Lo(comm, region, year, slice)$mInp2Lo(comm, region, year, slice)
print("eqInp2Lo(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mInp2Lo], sum(vInp2Lo[(c,r,y,s,sp)] for sp in slice if (c,r,y,s,sp) in mvInp2Lo)  ==  (if (c,r,y,s) in mTechInpTot; vTechInpTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mStorageInpTot; vStorageInpTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mExport; vExportTot[(c,r,y,s)]; else 0; end;)+(if (c,r,y,s) in mvTradeIrAInpTot; vTradeIrAInpTot[(c,r,y,s)]; else 0; end;)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqSupOutTot(comm, region, year, slice)$mSupOutTot(comm, region, year, slice)
print("eqSupOutTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mSupOutTot], vSupOutTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(sum(vSupOut[(s1,c,r,y,sp)] for sp in slice if ((c,s,sp) in mCommSliceOrParent && (s1,c,r,y,sp) in mSupAva)) for s1 in sup if (s1,c) in mSupComm)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechInpTot(comm, region, year, slice)$mTechInpTot(comm, region, year, slice)
print("eqTechInpTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mTechInpTot], vTechInpTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(sum((if (t,c,r,y,sp) in mvTechInp; vTechInp[(t,c,r,y,sp)]; else 0; end;) for sp in slice if ((t,sp) in mTechSlice && (c,s,sp) in mCommSliceOrParent)) for t in tech if (t,c) in mTechInpComm)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(sum((if (t,c,r,y,sp) in mvTechAInp; vTechAInp[(t,c,r,y,sp)]; else 0; end;) for sp in slice if ((t,sp) in mTechSlice && (c,s,sp) in mCommSliceOrParent)) for t in tech if (t,c) in mTechAInp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqTechOutTot(comm, region, year, slice)$mTechOutTot(comm, region, year, slice)
print("eqTechOutTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mTechOutTot], vTechOutTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(sum((if (t,c,r,y,sp) in mvTechOut; vTechOut[(t,c,r,y,sp)]; else 0; end;) for sp in slice if ((t,sp) in mTechSlice && (c,s,sp) in mCommSliceOrParent)) for t in tech if (t,c) in mTechOutComm)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(sum((if (t,c,r,y,sp) in mvTechAOut; vTechAOut[(t,c,r,y,sp)]; else 0; end;) for sp in slice if ((t,sp) in mTechSlice && (c,s,sp) in mCommSliceOrParent)) for t in tech if (t,c) in mTechAOut)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqStorageInpTot(comm, region, year, slice)$mStorageInpTot(comm, region, year, slice)
print("eqStorageInpTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mStorageInpTot], vStorageInpTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vStorageInp[(st1,c,r,y,s)] for st1 in stg if (st1,c,r,y,s) in mvStorageStore)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vStorageAInp[(st1,c,r,y,s)] for st1 in stg if (st1,c,r,y,s) in mvStorageAInp)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqStorageOutTot(comm, region, year, slice)$mStorageOutTot(comm, region, year, slice)
print("eqStorageOutTot(comm, region, year, slice)...")
@constraint(model, [(c, r, y, s) in mStorageOutTot], vStorageOutTot[(c,r,y,s)]  ==  (if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vStorageOut[(st1,c,r,y,s)] for st1 in stg if (st1,c,r,y,s) in mvStorageStore)+(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*sum(vStorageAOut[(st1,c,r,y,s)] for st1 in stg if (st1,c,r,y,s) in mvStorageAOut)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
# eqCost(region, year)$mvTotalCost(region, year)
print("eqCost(region, year)...")
@constraint(model, [(r, y) in mvTotalCost], vTotalCost[(r,y)]  ==  sum(vTechEac[(t,r,y)] for t in tech if (t,r,y) in mTechEac)+sum(vTechOMCost[(t,r,y)] for t in tech if (t,r,y) in mTechOMCost)+sum(vSupCost[(s1,r,y)] for s1 in sup if (s1,r,y) in mvSupCost)+sum((if haskey(pDummyImportCost, (c,r,y,s)); pDummyImportCost[(c,r,y,s)]; else pDummyImportCostDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vDummyImport[(c,r,y,s)] for c in comm for s in slice if (c,r,y,s) in mDummyImport)+sum((if haskey(pDummyExportCost, (c,r,y,s)); pDummyExportCost[(c,r,y,s)]; else pDummyExportCostDef; end)*(if haskey(pSliceWeight, (s)); pSliceWeight[(s)]; else pSliceWeightDef; end)*vDummyExport[(c,r,y,s)] for c in comm for s in slice if (c,r,y,s) in mDummyExport)+sum(vTaxCost[(c,r,y)] for c in comm if (c,r,y) in mTaxCost)-sum(vSubsCost[(c,r,y)] for c in comm if (c,r,y) in mSubCost)+sum(vStorageOMCost[(st1,r,y)] for st1 in stg if (st1,r,y) in mStorageOMCost)+sum(vStorageEac[(st1,r,y)] for st1 in stg if (st1,r,y) in mStorageEac)+(if (r,y) in mvTradeCost; vTradeCost[(r,y)]; else 0; end;)+(if (r,y) in mvTotalUserCosts; vTotalUserCosts[(r,y)]; else 0; end;)); 
print(" ", Dates.format(now(), "HH:MM:SS"), "
")
