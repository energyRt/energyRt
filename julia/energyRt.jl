...
@constraint(model, [(st1, c, r, y, s) in meqStorageInpUp], vStorageInp[(st1,c,r,y,s)] <=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCinpUp, (st1,c,r,y,s)); pStorageCinpUp[(st1,c,r,y,s)]; else pStorageCinpUpDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCinpUp, (wth1,st1,c)); pStorageWeatherCinpUp[(wth1,st1,c)]; else pStorageWeatherCinpUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1,c) in mStorageWeatherCinpUp));
...
@constraint(model, [(st1, c, r, y, s) in meqStorageInpLo], vStorageInp[(st1,c,r,y,s)]  >=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCinpLo, (st1,c,r,y,s)); pStorageCinpLo[(st1,c,r,y,s)]; else pStorageCinpLoDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCinpLo, (wth1,st1,c)); pStorageWeatherCinpLo[(wth1,st1,c)]; else pStorageWeatherCinpLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1,c) in mStorageWeatherCinpLo));
...
@constraint(model, [(st1, c, r, y, s) in meqStorageOutUp], vStorageOut[(st1,c,r,y,s)] <=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCoutUp, (st1,c,r,y,s)); pStorageCoutUp[(st1,c,r,y,s)]; else pStorageCoutUpDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCoutUp, (wth1,st1,c)); pStorageWeatherCoutUp[(wth1,st1,c)]; else pStorageWeatherCoutUpDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1,c) in mStorageWeatherCoutUp));
...
@constraint(model, [(st1, c, r, y, s) in meqStorageOutLo], vStorageOut[(st1,c,r,y,s)]  >=  (if haskey(pStorageCap2stg, (st1)); pStorageCap2stg[(st1)]; else pStorageCap2stgDef; end)*vStorageCap[(st1,r,y)]*(if haskey(pStorageCoutLo, (st1,c,r,y,s)); pStorageCoutLo[(st1,c,r,y,s)]; else pStorageCoutLoDef; end)*(if haskey(pSliceShare, (s)); pSliceShare[(s)]; else pSliceShareDef; end)*prod((if haskey(pStorageWeatherCoutLo, (wth1,st1,c)); pStorageWeatherCoutLo[(wth1,st1,c)]; else pStorageWeatherCoutLoDef; end)*(if haskey(pWeather, (wth1,r,y,s)); pWeather[(wth1,r,y,s)]; else pWeatherDef; end) for wth1 in weather if (wth1,st1,c) in mStorageWeatherCoutLo));
