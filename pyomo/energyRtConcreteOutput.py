...
f.close()
flist.write("vTechOutTot1\n")
f = open("output/vTechOutTot1.csv", "w")
f.write("comm,region,year,slice,value\n")
for c, r, y, s in mTechOutTot:
    if model.vTechOutTot1[(c, r, y, s)].value != 0:
        f.write(
            str(c)
            + ","
            + str(r)
            ...
            + str(s)
            + ","
            + str(model.vTechOutTot1[(c, r, y, s)].value)
            + "\n"
        )
f.close()
flist.write("vTechOutTot2\n")
f = open("output/vTechOutTot2.csv", "w")
f.write("comm,region,year,slice,value\n")
for c, r, y, s in mTechOutTot:
    if model.vTechOutTot2[(c, r, y, s)].value != 0:
        f.write(
            str(c)
            + ","
            + str(r)
            ...
            + str(s)
            + ","
            + str(model.vTechOutTot2[(c, r, y, s)].value)
            + "\n"
        )
f.close()
flist.write("vTechOutTot3\n")
f = open("output/vTechOutTot3.csv", "w")
f.write("comm,region,year,slice,value\n")
for c, r, y, s in mTechOutTot:
    if model.vTechOutTot3[(c, r, y, s)].value != 0:
        f.write(
            str(c)
            + ","
            + str(r)
            ...
            + str(s)
            + ","
            + str(model.vTechOutTot3[(c, r, y, s)].value)
            + "\n"
        )
f.close()
flist.write("vTechOutTot4\n")
f = open("output/vTechOutTot4.csv", "w")
f.write("comm,region,year,slice,value\n")
for c, r, y, s in mTechOutTot:
    if model.vTechOutTot4[(c, r, y, s)].value != 0:
        f.write(
            str(c)
            + ","
            + str(r)
            ...
            + str(s)
            + ","
            + str(model.vTechOutTot4[(c, r, y, s)].value)
            + "\n"
        )
f.close()
