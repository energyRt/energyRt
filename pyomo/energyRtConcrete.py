...
flog.write('"model language",PyomoConcrete,"' + str(datetime.datetime.now().time()) + '"\n')
flog.write('"load data",,"' + str(datetime.datetime.now().time()) + '"\n')
import time
seconds = time.time()
import itertools
...
##### decl par #####
print("variables... " + str(datetime.datetime.now().time()) + " (" + str(round(time.time() - seconds, 2)) + " s)")
...
print("equations... " + str(datetime.datetime.now().time()) + " (" + str(round(time.time() - seconds, 2)) + " s)")
...
if verbose: print(datetime.datetime.now().time(), " (", round(time.time() - seconds, 2), " s)", sep = "")
...
flog.write('"solver",,"' + str(datetime.datetime.now().time()) + '"\n')
print("solving... ");
slv = opt.solve(model, tee = True)
print("done " + str(datetime.datetime.now().time()) + " (" + str(round(time.time() - seconds, 2)) + " s)");
flog.write('"solution status",' + str((slv.solver.status == SolverStatus.ok) *1) + ',"' + str(datetime.datetime.now().time()) + '"\n')
flog.write('"export results",,"' + str(datetime.datetime.now().time()) + '"\n')
exec(open("inc5.py").read())
exec(open("output.py").read())
flog.write('"done",,"' + str(datetime.datetime.now().time()) + '"\n')
flog.close();
