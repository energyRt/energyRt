...
model.vTechRetiredStock = Var(model.mvTechRetiredStock, domain = pyo.NonNegativeReals, doc = "Early retired capacity");
model.vTechRetiredNewCap = Var(model.mvTechRetiredNewCap, domain = pyo.NonNegativeReals, doc = "Early retired capacity");
...
model.vOutTot = Var(model.mvOutTot, domain = pyo.NonNegativeReals, doc = "Total commodity output (consumption is not counted)");
...
model.eqStorageCost = Constraint(model.mStorageOMCost, rule = lambda model, st1, r, y : model.vStorageOMCost[st1,r,y]  ==  model.pStorageFixom[st1,r,y]*model.vStorageCap[st1,r,y]+sum(sum(model.pStorageCostInp[st1,r,y,s]*model.vStorageInp[st1,c,r,y,s]+model.pStorageCostOut[st1,r,y,s]*model.vStorageOut[st1,c,r,y,s]+model.pStorageCostStore[st1,r,y,s]*model.vStorageStore[st1,c,r,y,s] for s in model.slice if (c,s) in model.mCommSlice) for c in model.comm if (st1,c) in model.mStorageComm));
