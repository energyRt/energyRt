...
model.eqTechRampUp = Constraint(model.mTechRampUp, rule = lambda model, t, r, y, s : model.vTechAct[t,r,y,s]-sum(model.vTechAct[t,r,y,sp] for sp in model.slice if (((t in model.mTechFullYear and (sp,s) in model.mSliceNext) or (not((t in model.mTechFullYear)) and (sp,s) in model.mSliceFYearNext)) and (t,r,y,sp) in model.mvTechAct)) <=  model.pSliceShare[s]*model.pTechRampUp[t,r,y,s]*model.pTechCap2act[t]*model.vTechCap[t,r,y]);
# eqTechRampDown(tech, region, year, slice)$mTechRampDown(tech, region, year, slice)
model.eqTechRampDown = Constraint(model.mTechRampDown, rule = lambda model, t, r, y, s : sum(model.vTechAct[t,r,y,sp] for sp in model.slice if (((t in model.mTechFullYear and (sp,s) in model.mSliceNext) or (not((t in model.mTechFullYear)) and (sp,s) in model.mSliceFYearNext)) and (t,r,y,sp) in model.mvTechAct))-model.vTechAct[t,r,y,s] <=  model.pSliceShare[s]*model.pTechRampDown[t,r,y,s]*model.pTechCap2act[t]*model.vTechCap[t,r,y]);
