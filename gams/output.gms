...
putclose; 
file vTechRetCap_csv / 'output/vTechRetCap.csv'/;
vTechRetCap_csv.lp = 1;
vTechRetCap_csv.nd = 1;
vTechRetCap_csv.nz = 1e-25;
vTechRetCap_csv.nr = 2;
put vTechRetCap_csv;
put "tech,region,year,value"/;
loop((tech,region,year)$(vTechRetCap.l(tech,region,year) and mMidMilestone(year)), put tech.tl:0",", region.tl:0",", year.tl:0","vTechRetCap.l(tech,region,year):0:15/;);
putclose; 
file vTechERetCap_csv / 'output/vTechERetCap.csv'/;
vTechERetCap_csv.lp = 1;
vTechERetCap_csv.nd = 1;
vTechERetCap_csv.nz = 1e-25;
vTechERetCap_csv.nr = 2;
put vTechERetCap_csv;
put "tech,region,year,value"/;
loop((tech,region,year)$(vTechERetCap.l(tech,region,year) and mMidMilestone(year)), put tech.tl:0",", region.tl:0",", year.tl:0","vTechERetCap.l(tech,region,year):0:15/;);
putclose; 
