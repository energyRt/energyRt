...
putclose; 
file vTechSalv_csv / 'output/vTechSalv.csv'/;
vTechSalv_csv.lp = 1;
vTechSalv_csv.nd = 1;
...
putclose; 
file vTechEmsFuel_csv / 'output/vTechEmsFuel.csv'/;
...
putclose; 
file vCost_csv / 'output/vCost.csv'/;
vCost_csv.lp = 1;
vCost_csv.nd = 1;
vCost_csv.nz = 1e-25;
vCost_csv.nr = 2;
...
putclose; 
file vStorageSalv_csv / 'output/vStorageSalv.csv'/;
...
putclose; 
file vTradeSalv_csv / 'output/vTradeSalv.csv'/;
vTradeSalv_csv.lp = 1;
vTradeSalv_csv.nd = 1;
vTradeSalv_csv.nz = 1e-25;
vTradeSalv_csv.nr = 2;
put vTradeSalv_csv;
put "trade,region,value"/;
loop((trade,region)$vTradeSalv.l(trade,region), put trade.tl:0",", region.tl:0","vTradeSalv.l(trade,region):0:15/;);
putclose; 
file vTechUse_csv / 'output/vTechUse.csv'/;
vTechUse_csv.lp = 1;
vTechUse_csv.nd = 1;
...
putclose; 
file vTechRetiredCap_csv / 'output/vTechRetiredCap.csv'/;
...
putclose; 
file vDummyCost_csv / 'output/vDummyCost.csv'/;
vDummyCost_csv.lp = 1;
vDummyCost_csv.nd = 1;
