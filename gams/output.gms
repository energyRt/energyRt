...
putclose; 
file vTechOutS_csv / 'output/vTechOutS.csv'/;
vTechOutS_csv.lp = 1;
vTechOutS_csv.nd = 1;
vTechOutS_csv.nz = 1e-25;
vTechOutS_csv.nr = 2;
put vTechOutS_csv;
put "tech,comm,region,year,slice,value"/;
loop((tech,comm,region,year,slice)$(vTechOutS.l(tech,comm,region,year,slice) and mMidMilestone(year)), put tech.tl:0",", comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechOutS.l(tech,comm,region,year,slice):0:15/;);
putclose; 
...
putclose; 
file vTechAOutS_csv / 'output/vTechAOutS.csv'/;
vTechAOutS_csv.lp = 1;
vTechAOutS_csv.nd = 1;
vTechAOutS_csv.nz = 1e-25;
vTechAOutS_csv.nr = 2;
put vTechAOutS_csv;
put "tech,comm,region,year,slice,value"/;
loop((tech,comm,region,year,slice)$(vTechAOutS.l(tech,comm,region,year,slice) and mMidMilestone(year)), put tech.tl:0",", comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechAOutS.l(tech,comm,region,year,slice):0:15/;);
putclose; 
