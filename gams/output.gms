...
putclose; 
file vTechOutRY_csv / 'output/vTechOutRY.csv'/;
vTechOutRY_csv.lp = 1;
vTechOutRY_csv.nd = 1;
vTechOutRY_csv.nz = 1e-25;
vTechOutRY_csv.nr = 2;
put vTechOutRY_csv;
put "tech,comm,region,year,value"/;
loop((tech,comm,region,year)$(vTechOutRY.l(tech,comm,region,year) and mMidMilestone(year)), put tech.tl:0",", comm.tl:0",", region.tl:0",", year.tl:0","vTechOutRY.l(tech,comm,region,year):0:15/;);
putclose; 
