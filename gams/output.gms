...
putclose; 
file vTechOutTot1_csv / 'output/vTechOutTot1.csv'/;
vTechOutTot1_csv.lp = 1;
vTechOutTot1_csv.nd = 1;
vTechOutTot1_csv.nz = 1e-25;
vTechOutTot1_csv.nr = 2;
put vTechOutTot1_csv;
put "comm,region,year,slice,value"/;
loop((comm,region,year,slice)$(vTechOutTot1.l(comm,region,year,slice) and mMidMilestone(year)), put comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechOutTot1.l(comm,region,year,slice):0:15/;);
putclose; 
file vTechOutTot2_csv / 'output/vTechOutTot2.csv'/;
vTechOutTot2_csv.lp = 1;
vTechOutTot2_csv.nd = 1;
vTechOutTot2_csv.nz = 1e-25;
vTechOutTot2_csv.nr = 2;
put vTechOutTot2_csv;
put "comm,region,year,slice,value"/;
loop((comm,region,year,slice)$(vTechOutTot2.l(comm,region,year,slice) and mMidMilestone(year)), put comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechOutTot2.l(comm,region,year,slice):0:15/;);
putclose; 
file vTechOutTot3_csv / 'output/vTechOutTot3.csv'/;
vTechOutTot3_csv.lp = 1;
vTechOutTot3_csv.nd = 1;
vTechOutTot3_csv.nz = 1e-25;
vTechOutTot3_csv.nr = 2;
put vTechOutTot3_csv;
put "comm,region,year,slice,value"/;
loop((comm,region,year,slice)$(vTechOutTot3.l(comm,region,year,slice) and mMidMilestone(year)), put comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechOutTot3.l(comm,region,year,slice):0:15/;);
putclose; 
file vTechOutTot4_csv / 'output/vTechOutTot4.csv'/;
vTechOutTot4_csv.lp = 1;
vTechOutTot4_csv.nd = 1;
vTechOutTot4_csv.nz = 1e-25;
vTechOutTot4_csv.nr = 2;
put vTechOutTot4_csv;
put "comm,region,year,slice,value"/;
loop((comm,region,year,slice)$(vTechOutTot4.l(comm,region,year,slice) and mMidMilestone(year)), put comm.tl:0",", region.tl:0",", year.tl:0",", slice.tl:0","vTechOutTot4.l(comm,region,year,slice):0:15/;);
putclose; 
