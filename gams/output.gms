...
putclose; 
file vTechRetiredStockDiff_csv / 'output/vTechRetiredStockDiff.csv'/;
vTechRetiredStockDiff_csv.lp = 1;
vTechRetiredStockDiff_csv.nd = 1;
vTechRetiredStockDiff_csv.nz = 1e-25;
vTechRetiredStockDiff_csv.nr = 2;
put vTechRetiredStockDiff_csv;
put "tech,region,year,value"/;
loop((tech,region,year)$(vTechRetiredStockDiff.l(tech,region,year) and mMidMilestone(year)), put tech.tl:0",", region.tl:0",", year.tl:0","vTechRetiredStockDiff.l(tech,region,year):0:15/;);
putclose; 
