...
putclose; 
file vTechRetirementStock_csv / 'output/vTechRetirementStock.csv'/;
vTechRetirementStock_csv.lp = 1;
vTechRetirementStock_csv.nd = 1;
vTechRetirementStock_csv.nz = 1e-25;
vTechRetirementStock_csv.nr = 2;
put vTechRetirementStock_csv;
put "tech,region,year,value"/;
loop((tech,region,year)$(vTechRetirementStock.l(tech,region,year) and mMidMilestone(year)), put tech.tl:0",", region.tl:0",", year.tl:0","vTechRetirementStock.l(tech,region,year):0:15/;);
putclose; 
file vTechRetirementNewCap_csv / 'output/vTechRetirementNewCap.csv'/;
vTechRetirementNewCap_csv.lp = 1;
vTechRetirementNewCap_csv.nd = 1;
vTechRetirementNewCap_csv.nz = 1e-25;
vTechRetirementNewCap_csv.nr = 2;
put vTechRetirementNewCap_csv;
put "tech,region,year,yearp,value"/;
loop((tech,region,year,yearp)$(vTechRetirementNewCap.l(tech,region,year,yearp) and mMidMilestone(year)), put tech.tl:0",", region.tl:0",", year.tl:0",", yearp.tl:0","vTechRetirementNewCap.l(tech,region,year,yearp):0:15/;);
putclose; 
...
put variable_list_csv;
    ...
    put "vTradeIrCost"/;
    put "vTechNewCap"/;
    put "vTechRetirementStock"/;
    put "vTechRetirementNewCap"/;
    put "vTechCap"/;
    put "vTechAct"/;
    put "vTechInp"/;
    put "vTechOut"/;
